...
description: >-
  Migrate from SDK version 0.37 to 0.38 with updated module structure and API
  changes.
keywords:
  - migration
  - 0.38.0
  ...
  - refactoring
questions:
  - How do I migrate Migrate to 0.38.0?
  - What changed in Migrate to 0.38.0?
  - What are the breaking changes in Migrate to 0.38.0?
answer: >-
  Migrate from SDK version 0.37 to 0.38 with updated module structure and API
  changes.
goal:
  description: Reader can migrate their code to Migrate to 0.38.0
  requires:
    - has_frontmatter:
        - title
        - description
