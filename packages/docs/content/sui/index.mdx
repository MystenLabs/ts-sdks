...
questions:
  ...
  - What is @mysten/sui?
answer: >-
  The Sui TypeScript SDK (@mysten/sui) is the official SDK for building on Sui,
  providing clients for gRPC/GraphQL/JSON-RPC, transaction building,
  cryptographic signing, and BCS serialization.
goal:
  description: >-
    Reader can install @mysten/sui and make their first RPC call to the Sui
    network
  requires:
    - has_frontmatter:
        - title
