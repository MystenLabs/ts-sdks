...
type DefaultTypeArgs<Name extends string> = TypeArgsOf<Name> extends infer D extends
	TypeArgumentsFor<Name>
	? D
	: never;
...
function buildTypeTag(name: string, options: BuildTypeTagOptions | string | undefined): string {
	if (typeof options === 'string') {
		...
		throw new __ERROR_CLASS__(options);
	}
...
> extends BcsStruct<T, Name> {
	...
	>(...args: TypeTagParams<Name, Args, P>): ReplacePackage<
		BuiltTag<Name, NoInfer<Args>>,
		NoInfer<P>
	> {
