...
keywords: [SuiJsonRpcClient, JSON-RPC, Sui client, deprecated, TypeScript SDK, Core API, @mysten/sui, migration]
---
...
`signAndExecuteTransaction` to wait for the transaction to be available through the API. This currently
