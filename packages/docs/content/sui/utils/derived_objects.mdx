...
description: >-
  Compute derived object IDs from parent objects for deterministic offline
  derivation.
keywords:
  - derived objects
  - deriveObjectID
...
questions:
  ...
  - How does Derived Objects work?
answer: >-
  Compute derived object IDs from parent objects for deterministic offline
  derivation.
goal:
  description: Reader understands and can use Derived Objects
  requires:
    - has_frontmatter:
        - title
        - description
