...
keywords:
  ...
  - keypair
questions:
  - How do I signing and execution in Sui dApp Kit?
  - What is the Signing and Execution action?
  - How do I use Signing and Execution?
answer: Sign transactions and execute them on the Sui network
goal:
  description: Reader can use Signing and Execution in their application
  requires:
    - has_frontmatter:
        - title
        - description
