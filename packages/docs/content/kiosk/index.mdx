...
answer: >-
  The Kiosk SDK (@mysten/kiosk) provides TypeScript bindings for Sui Kiosk,
  enabling onchain commerce with listing, purchasing, transfer policy
  management, and royalty enforcement.
goal:
  description: >-
    Reader understands the Kiosk SDK and can start building onchain commerce on
    Sui
  requires:
    - has_frontmatter:
        - title
