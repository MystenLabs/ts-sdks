...
answer: >-
  Plugins let you extend Sui client behavior with middleware-style interceptors
  for logging, caching, retry logic, and custom transformations on requests and
  responses.
goal:
