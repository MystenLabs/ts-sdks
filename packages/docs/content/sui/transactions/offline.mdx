...
keywords:
  ...
  - party objects
questions:
  - How do I building offline in Sui dApp Kit?
  - What is the Building Offline action?
  - How do I use Building Offline?
answer: Build transactions without a network connection
goal:
  description: Reader can use Building Offline in their application
  requires:
    - has_frontmatter:
        - title
        - description
