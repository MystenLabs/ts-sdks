...
export function mistPerSui(
	options: MistPerSuiOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/core';
	return (tx: Transaction) =>
		tx.moveCall({
...
export function minDomainLength(
	options: MinDomainLengthOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/core';
	return (tx: Transaction) =>
		tx.moveCall({
...
export function maxDomainLength(
	options: MaxDomainLengthOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/core';
	return (tx: Transaction) =>
		tx.moveCall({
...
export function gracePeriodMs(
	options: GracePeriodMsOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/core';
	return (tx: Transaction) =>
		tx.moveCall({
...
export function subdomainAllowCreationKey(
	options: SubdomainAllowCreationKeyOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/core';
	return (tx: Transaction) =>
		tx.moveCall({
...
export function subdomainAllowExtensionKey(
	options: SubdomainAllowExtensionKeyOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/core';
	return (tx: Transaction) =>
		tx.moveCall({
...
export function leafExpirationTimestamp(
	options: LeafExpirationTimestampOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/core';
	return (tx: Transaction) =>
		tx.moveCall({
