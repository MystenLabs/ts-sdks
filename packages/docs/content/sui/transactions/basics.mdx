...
answer: >-
  Use the Transaction class to build programmable transaction blocks: chain
  commands like splitCoins, mergeCoins, moveCall, and transferObjects into a
  single atomic transaction.
goal:
  description: >-
    Reader can construct programmable transaction blocks with the Transaction
    API
  requires:
    - has_frontmatter:
        - title
