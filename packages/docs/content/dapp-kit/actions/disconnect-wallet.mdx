...
description: Programmatically disconnect from a Sui wallet using the dApp Kit disconnectWallet action.
keywords: [disconnect wallet, dApp Kit, wallet disconnection, Sui, action, TypeScript]
---
...
<Callout>
	The action might throw `WalletNotConnectedError` if no wallet is connected. However, wallet-specific
