...
| --------------------------------------------- | --------- | ------------ | --------- | ----------------------------- |
| [InMemory](/dev-wallet/adapters/in-memory)    | Ed25519   | None         | Yes       | Quick prototyping, unit tests |
| [WebCrypto](/dev-wallet/adapters/webcrypto)   | Secp256r1 | IndexedDB    | Yes       | Persistent dev accounts       |
| [Passkey](/dev-wallet/adapters/passkey)       | Secp256r1 | Browser + OS | No        | Testing passkey flows         |
| [Remote CLI](/dev-wallet/adapters/remote-cli) | Any       | External     | No        | Using `sui` CLI keystore      |
...
[Custom Adapters](/dev-wallet/adapters/custom).
