---
title: Faucet
description: Request test SUI tokens from the faucet on Devnet, Testnet, or local networks.
keywords: [faucet, test tokens, SUI, Devnet, Testnet, requestSuiFromFaucetV2, @mysten/sui, airdrop]
---
