...
export const BigVector: MoveStruct<{
    "id": typeof bcs.Address;
    "depth": ReturnType<typeof bcs.u8>;
    "length": ReturnType<typeof bcs.u64>;
    "max_slice_size": ReturnType<typeof bcs.u64>;
    "max_fan_out": ReturnType<typeof bcs.u64>;
    "root_id": ReturnType<typeof bcs.u64>;
    "last_id": ReturnType<typeof bcs.u64>;
}> = new MoveStruct({ name: `${$moduleName}::BigVector<phantom E>`, fields: {
        id: bcs.Address,
...
export function Slice<E extends BcsType<any>>(...typeParameters: [
    ...
    return new MoveStruct({ name: `${$moduleName}::Slice<${typeParameters[0].name as E['name']}>`, fields: {
...
export const SliceRef: MoveStruct<{
    "ix": ReturnType<typeof bcs.u64>;
}> = new MoveStruct({ name: `${$moduleName}::SliceRef`, fields: {
        ix: bcs.u64()
    } });