...
questions:
  ...
  - How do I get started with Sui dApp Kit?
  - How do I install Sui dApp Kit?
answer: Build Sui apps with framework-agnostic core and React bindings.
goal:
  description: >-
    Reader understands what Sui dApp Kit is, how to install it, and its core
    capabilities
  requires:
    - has_frontmatter:
        - title
