...
const paymentParams = {
	nonce: '0f6a09cf-7b46-4e31-adce-f39e463ccae5', // Unique identifier for this payment
...
6. **Registry Name**: The payment registry to use (defaults to `default-payment-registry`)
...
## Extracting the Payment Receipt

Payment receipts are emitted as events. You can extract them from the transaction result:

```ts
// Get events from the transaction result
const events = result.events || [];

// Find the PaymentReceipt event
const receiptEvent = events.find((event) => event.type.includes('PaymentReceipt'));
...
const tx = client.paymentKit.tx.processEphemeralPayment({
	nonce: '9d1fddd9-fe9b-4301-b54f-a59edd6a1b2a',
	coinType: '0x2::sui::SUI',
	amount: 1000000000,
	receiver: '0x742d35cc6634c0532925a3b844bc9c7eb6fb05f44228e1a3e0e1de2fd929fdda',
	sender: sender,
...
- [Examples](./examples) - Common payment scenarios and patterns
