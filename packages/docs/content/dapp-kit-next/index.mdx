...
For a quick overview of the setup process and core concepts, see the [Getting Started](./dapp-kit-next/getting-started)
page or check the following the framework-specific guides:
