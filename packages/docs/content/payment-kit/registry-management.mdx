...
description: >-
  Create, configure, and manage payment registries and accepted coin types on
  Sui.
keywords:
  - PaymentRegistry
  - registry management
...
questions:
  ...
  - How does Registry Management work?
answer: >-
  Create, configure, and manage payment registries and accepted coin types on
  Sui.
goal:
  description: Reader understands and can use Registry Management
  requires:
    - has_frontmatter:
        - title
        - description
