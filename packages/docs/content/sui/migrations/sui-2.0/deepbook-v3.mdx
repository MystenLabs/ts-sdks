...
keywords:
  ...
  - breaking changes
questions:
  - How do I migrate @mysten/deepbook-v3?
  - What changed in @mysten/deepbook-v3?
  - What are the breaking changes in @mysten/deepbook-v3?
answer: Migrate @mysten/deepbook-v3 to 2.0 with client extension pattern
goal:
  description: Reader can migrate their code to @mysten/deepbook-v3
  requires:
    - has_frontmatter:
        - title
        - description
