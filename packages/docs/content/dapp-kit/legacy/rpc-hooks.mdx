---
title: RPC Hooks
description: React hooks for querying the Sui blockchain using JSON RPC methods.
keywords:
  - RPC hooks
  - useSuiClientQuery
  - React
...
questions:
  - What is RPC Hooks?
  - How do I use RPC Hooks?
  - How does useSuiClientQuery work?
  - How does useSuiClientQueries work?
answer: React hooks for querying the Sui blockchain using JSON RPC methods.
goal:
  description: >-
    Reader can use the React hooks for querying the Sui blockchain using JSON RPC methods
  requires:
    - has_frontmatter:
        - title
        - description
