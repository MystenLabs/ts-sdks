...
title: Querying
description: >-
  Query kiosk contents, owned kiosks, items, and transfer policies using the
  Kiosk SDK.
keywords:
  - kiosk querying
  - getOwnedKiosks
...
goal:
  description: >-
    Reader understands query kiosk contents, owned kiosks, items, and transfer
    policies using the Kiosk SDK
  requires:
    - has_frontmatter:
        - title
        - description
