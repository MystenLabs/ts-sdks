...
description: >-
  Sign transactions using the Web Crypto API for secure browser-based key
  management
keywords:
  - Web Crypto API
  - signer
  ...
  - session keys
questions:
  - How do I use Web Crypto Signer?
  - How do I set up Web Crypto Signer?
  - What is Web Crypto Signer in the Sui SDK?
answer: >-
  Sign transactions using the Web Crypto API for secure browser-based key
  management
goal:
  description: Reader understands and can use Web Crypto Signer
  requires:
    - has_frontmatter:
        - title
        - description
