...
export const Domain: MoveStruct<{
    "labels": ReturnType<typeof bcs.vector<ReturnType<typeof bcs.string>>>;
}> = new MoveStruct({ name: `${$moduleName}::Domain`, fields: {
        /**
...
export function toString(options: ToStringOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
 ...
 */
export function label(options: LabelOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    const argumentsTypes = [
        null,
        'u64'
 ...
 * "name.sui" -> "sui"
 */
export function tld(options: TldOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
 ...
 * "name.sui" -> "sui"
 */
export function sld(options: SldOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export interface NumberOfLevelsOptions {
    package?: string;
    arguments: NumberOfLevelsArguments | [
        self: TransactionArgument
    ];
}
export function numberOfLevels(options: NumberOfLevelsOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export interface IsSubdomainOptions {
    package?: string;
    arguments: IsSubdomainArguments | [
        domain: TransactionArgument
    ];
}
export function isSubdomain(options: IsSubdomainOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export function parent(options: ParentOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export interface IsParentOfOptions {
    package?: string;
    arguments: IsParentOfArguments | [
        parent: TransactionArgument,
        child: TransactionArgument
    ];
}
/** Checks if `parent` domain is a valid parent for `child`. */
export function isParentOf(options: IsParentOfOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    const argumentsTypes = [
        null,
        null
