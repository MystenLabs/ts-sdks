...
answer: >-
  Sui codegen (@mysten/codegen) generates type-safe TypeScript bindings from
  onchain Sui Move packages, providing typed transaction builders and BCS
  serialization for your contracts.
goal:
