...
description: >-
  Utility functions for addresses, coins, and common operations in the Sui
  TypeScript SDK.
keywords:
  - utils
  - utility functions
...
questions:
  ...
  - How do I use The @mysten/sui/utils package?
  - How does The @mysten/sui/utils package work?
answer: >-
  Utility functions for addresses, coins, and common operations in the Sui
  TypeScript SDK.
goal:
  description: >-
    Reader understands what The @mysten/sui/utils package is, how to install it,
