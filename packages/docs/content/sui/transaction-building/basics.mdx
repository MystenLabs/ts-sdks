...
keywords: [programmable transactions, Transaction, transaction building, Sui, splitCoins, moveCall, transferObjects, TypeScript SDK]
---
...
You might need to explicitly call `setSender()` on the transaction to ensure that the
