...
questions:
  - What is Sponsor?
  - How do I get started with Sponsor?
  - How do I install Sponsor?
answer: Build gas sponsorship services with pluggable transaction validation
goal:
  description: >-
    Reader understands what Sponsor is, how to install it, and its core
    capabilities
  requires:
    - has_frontmatter:
        - title
