...
description: Framework-agnostic web component providing a complete wallet connection UI for Sui dApps.
keywords: [connect button, web component, wallet connection, framework-agnostic, dApp Kit, Sui, custom element]
---
