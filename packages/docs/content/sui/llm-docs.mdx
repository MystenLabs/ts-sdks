...
keywords:
  ...
  - SDK docs
questions:
  - What is LLM Documentation?
  - How do I use LLM Documentation?
  - How does LLM Documentation work?
answer: Give AI agents access to Sui SDK documentation in your project.
goal:
  description: Reader understands and can use LLM Documentation
  requires:
    - has_frontmatter:
        - title
        - description
