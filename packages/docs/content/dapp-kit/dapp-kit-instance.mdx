...
keywords: [createDAppKit, dApp Kit, configuration, wallet management, Sui client, network setup, TypeScript]
---
...
- **networks:** A list of networks supported by the application (for example, `['mainnet', 'testnet']`)
