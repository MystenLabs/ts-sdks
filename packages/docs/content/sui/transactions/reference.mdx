...
[ownership types](https://docs.sui.io/guides/developer/objects/object-ownership), including address-owned,
...
(read, write, delete, or transfer). They are referenced the same way as shared objects:
