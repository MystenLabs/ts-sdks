...
description: Connect your app to Slush Wallet using the Slush Wallet SDK and wallet standard.
keywords: [Slush Wallet, app integration, registerSlushWallet, wallet standard, Sui, web wallet, SDK]
---
...
<Callout>
	In the connect modal, users with the Slush Wallet extension installed only see the
	extension. If they don’t have it, the connection defaults to the Slush web app.
</Callout>
