...
export const CoreConfig: MoveStruct<{
    "public_key": ReturnType<typeof bcs.vector<ReturnType<typeof bcs.u8>>>;
    "min_label_length": ReturnType<typeof bcs.u8>;
    "max_label_length": ReturnType<typeof bcs.u8>;
    "valid_tlds": ReturnType<typeof vec_set.VecSet<ReturnType<typeof bcs.string>>>;
    "payments_version": ReturnType<typeof bcs.u8>;
    "max_years": ReturnType<typeof bcs.u8>;
    "extra": ReturnType<typeof vec_map.VecMap<ReturnType<typeof bcs.string>, ReturnType<typeof bcs.string>>>;
}> = new MoveStruct({ name: `${$moduleName}::CoreConfig`, fields: {
...
export function _new(options: NewOptions): (tx: Transaction) => TransactionResult {
    ...
    const parameterNames = ["publicKey", "minLabelLength", "maxLabelLength", "paymentsVersion", "maxYears", "validTlds", "extra"];
...
export interface MinLabelLengthOptions {
    package?: string;
    arguments: MinLabelLengthArguments | [
        config: TransactionArgument
    ];
}
export function minLabelLength(options: MinLabelLengthOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export interface MaxLabelLengthOptions {
    package?: string;
    arguments: MaxLabelLengthArguments | [
        config: TransactionArgument
    ];
}
export function maxLabelLength(options: MaxLabelLengthOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export interface IsValidTldOptions {
    package?: string;
    arguments: IsValidTldArguments | [
        config: TransactionArgument,
        tld: RawTransactionArgument<string>
    ];
}
export function isValidTld(options: IsValidTldOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    const argumentsTypes = [
        null,
        '0x1::string::String'
...
export interface PaymentsVersionOptions {
    package?: string;
    arguments: PaymentsVersionArguments | [
        config: TransactionArgument
    ];
}
export function paymentsVersion(options: PaymentsVersionOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export interface MaxYearsOptions {
    package?: string;
    arguments: MaxYearsArguments | [
        config: TransactionArgument
    ];
}
export function maxYears(options: MaxYearsOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
