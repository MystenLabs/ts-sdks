...
title: Walrus SDK
description: >-
  Store and retrieve blobs on Walrus decentralized storage using the TypeScript
  SDK.
keywords:
  - Walrus SDK
...
answer: >-
  The Walrus SDK (@mysten/walrus) provides TypeScript bindings for storing and
  retrieving blobs on Walrus decentralized storage, with support for upload,
  download, and blob metadata.
goal:
