		...
		<div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
			<div className="bg-white rounded-xl shadow-2xl max-w-3xl w-full max-h-[95vh] flex flex-col overflow-hidden">
				...
				<div className="flex-1 overflow-y-auto">
					...
					{!autoApprove?.enabled && autoApprove?.reason && !autoApprove.cancelled && (
					...
					{autoApprove?.cancelled &&
						onRemovePolicy &&
						!(autoApprove?.enabled && countdown !== null && countdown !== undefined) && (
				...
				<div className="px-6 py-4 border-t border-gray-200 bg-gray-50">
					{autoApprove?.enabled && countdown !== null && countdown !== undefined ? (
						<AutoApprovalCountdown
							...
							reason={autoApprove.reason}
							policyInfo={autoApprove.policyInfo}
						...
						<SigningActions
							...
							onApprove={onApprove}
							onReject={onReject}
							onEnableAutoApprovals={onEnableAutoApprovals}
						/>
					)}
				</div>
			</div>
