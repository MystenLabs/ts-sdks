...
[Coins and Balances](./coins-and-balances#using-coinwithbalance-recommended). Here's a summary of
its options:
...
and `tx.addIntentResolver()`. See [Transaction Plugins](../plugins) and
[SDK Building](../sdk-building) for details on building composable transaction libraries.
