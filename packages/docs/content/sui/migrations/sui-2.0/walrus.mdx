...
keywords:
  ...
  - breaking changes
questions:
  - How do I migrate @mysten/walrus?
  - What changed in @mysten/walrus?
  - What are the breaking changes in @mysten/walrus?
answer: Migrate @mysten/walrus to 2.0 with required client parameter and updated API
goal:
  description: Reader can migrate their code to @mysten/walrus
  requires:
    - has_frontmatter:
        - title
        - description
