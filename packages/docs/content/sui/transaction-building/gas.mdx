...
description: 'Configure gas budget, price, and coin selection for Sui transactions.'
keywords: [gas, gas budget, gas price, coin selection, Sui transactions, splitCoin, mergeCoins, payment]
---
...
The gas budget is represented in Sui and should take the gas price of the transaction
into account.
