...
description: >-
  Programmatically connect to a Sui wallet using the dApp Kit connectWallet
  action.
keywords:
  - connect wallet
  - dApp Kit
  ...
  - TypeScript
questions:
  - How do I connect wallet in Sui dApp Kit?
  - What is the Connect Wallet action?
  - How do I use Connect Wallet?
answer: >-
  Programmatically connect to a Sui wallet using the dApp Kit connectWallet
  action.
goal:
  description: Reader can use Connect Wallet in their application
  requires:
    - has_frontmatter:
        - title
        - description
