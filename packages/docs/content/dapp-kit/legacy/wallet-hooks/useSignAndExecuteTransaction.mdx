...
keywords:
  ...
  - Sui
questions:
  - What is useSignAndExecuteTransaction?
  - How do I use useSignAndExecuteTransaction?
  - What does the useSignAndExecuteTransaction hook return?
answer: Legacy React hook to sign and execute a transaction block on the Sui network.
goal:
  description: Reader can use useSignAndExecuteTransaction in their application
  requires:
    - has_frontmatter:
        - title
        - description
