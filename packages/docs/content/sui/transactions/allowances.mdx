...
**funder's** address balance, subject to spending limits. The funder creates it; the spender signs
transactions that use it. The network must have allowance support enabled (protocol v137 or later).
