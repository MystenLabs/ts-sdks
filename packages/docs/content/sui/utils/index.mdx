...
description: 'Utility functions for addresses, coins, and common operations in the Sui TypeScript SDK.'
keywords: [utils, utility functions, MIST_PER_SUI, address validation, coin formatting, "@mysten/sui/utils", constants, Sui]
---
