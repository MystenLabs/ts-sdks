...
description: >-
  Framework-agnostic web component providing a complete wallet connection UI for
  Sui dApps.
keywords:
  - connect button
  - web component
...
goal:
  description: >-
    Reader understands framework-agnostic web component providing a complete
    wallet connection UI for Sui dApps
  requires:
    - has_frontmatter:
        - title
        - description
