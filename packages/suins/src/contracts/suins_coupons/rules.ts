 ...
 */
export function newCouponRules(
	options: NewCouponRulesOptions,
...
export function newEmptyRules(
	options: NewEmptyRulesOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/coupons';
	return (tx: Transaction) =>
		tx.moveCall({
 ...
 */
export function decreaseAvailableClaims(
	options: DecreaseAvailableClaimsOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/coupons';
...
export function hasAvailableClaims(
	options: HasAvailableClaimsOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/coupons';
	const argumentsTypes = [null] satisfies (string | null)[];
	const parameterNames = ['rules'];
...
export function assertCouponValidForDomainYears(
	options: AssertCouponValidForDomainYearsOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/coupons';
...
export function isCouponValidForDomainYears(
	options: IsCouponValidForDomainYearsOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/coupons';
	const argumentsTypes = [null, 'u8'] satisfies (string | null)[];
	const parameterNames = ['rules', 'target'];
...
export function assertIsValidDiscountType(
	options: AssertIsValidDiscountTypeOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/coupons';
...
export function assertIsValidAmount(
	options: AssertIsValidAmountOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/coupons';
...
export function assertCouponValidForDomainSize(
	options: AssertCouponValidForDomainSizeOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/coupons';
	const argumentsTypes = [null, 'u8'] satisfies (string | null)[];
...
export function isCouponValidForDomainSize(
	options: IsCouponValidForDomainSizeOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/coupons';
	const argumentsTypes = [null, 'u8'] satisfies (string | null)[];
	const parameterNames = ['rules', 'length'];
...
export function assertCouponValidForAddress(
	options: AssertCouponValidForAddressOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/coupons';
...
export function isCouponValidForAddress(
	options: IsCouponValidForAddressOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/coupons';
	const argumentsTypes = [null, 'address'] satisfies (string | null)[];
	const parameterNames = ['rules', 'user'];
 ...
 * has expired.
 */
export function assertCouponIsNotExpired(
	options: AssertCouponIsNotExpiredOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/coupons';
...
export function isCouponExpired(
	options: IsCouponExpiredOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/coupons';
	const argumentsTypes = [null, '0x2::clock::Clock'] satisfies (string | null)[];
	const parameterNames = ['rules'];
