...
export const CouponRules: MoveStruct<{
    "length": ReturnType<typeof bcs.option<typeof range.Range>>;
    "available_claims": ReturnType<typeof bcs.option<ReturnType<typeof bcs.u64>>>;
    "user": ReturnType<typeof bcs.option<typeof bcs.Address>>;
    "expiration": ReturnType<typeof bcs.option<ReturnType<typeof bcs.u64>>>;
    "years": ReturnType<typeof bcs.option<typeof range.Range>>;
}> = new MoveStruct({ name: `${$moduleName}::CouponRules`, fields: {
...
export interface NewCouponRulesOptions {
    package?: string;
    arguments: NewCouponRulesArguments | [
        length: TransactionArgument,
        availableClaims: RawTransactionArgument<number | bigint | null>,
        user: RawTransactionArgument<string | null>,
        expiration: RawTransactionArgument<number | bigint | null>,
 ...
 */
export function newCouponRules(options: NewCouponRulesOptions): (tx: Transaction) => TransactionResult {
...
export function newEmptyRules(options: NewEmptyRulesOptions = {}): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/coupons';
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'rules',
...
export interface DecreaseAvailableClaimsOptions {
    package?: string;
    arguments: DecreaseAvailableClaimsArguments | [
        rules: TransactionArgument
    ];
}
/**
 ...
 */
export function decreaseAvailableClaims(options: DecreaseAvailableClaimsOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/coupons';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export interface HasAvailableClaimsOptions {
    package?: string;
    arguments: HasAvailableClaimsArguments | [
        rules: TransactionArgument
    ];
}
export function hasAvailableClaims(options: HasAvailableClaimsOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/coupons';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export interface AssertCouponValidForDomainYearsOptions {
    package?: string;
    arguments: AssertCouponValidForDomainYearsArguments | [
        rules: TransactionArgument,
        target: RawTransactionArgument<number>
    ];
}
export function assertCouponValidForDomainYears(options: AssertCouponValidForDomainYearsOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/coupons';
    const argumentsTypes = [
        null,
        'u8'
...
export interface IsCouponValidForDomainYearsOptions {
    package?: string;
    arguments: IsCouponValidForDomainYearsArguments | [
        rules: TransactionArgument,
        target: RawTransactionArgument<number>
    ];
}
export function isCouponValidForDomainYears(options: IsCouponValidForDomainYearsOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/coupons';
    const argumentsTypes = [
        null,
        'u8'
...
export interface AssertIsValidDiscountTypeOptions {
    package?: string;
    arguments: AssertIsValidDiscountTypeArguments | [
        type: RawTransactionArgument<number>
    ];
}
export function assertIsValidDiscountType(options: AssertIsValidDiscountTypeOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/coupons';
    const argumentsTypes = [
        'u8'
    ] satisfies (string | null)[];
...
export interface AssertIsValidAmountOptions {
    package?: string;
    arguments: AssertIsValidAmountArguments | [
        _: RawTransactionArgument<number>,
        amount: RawTransactionArgument<number | bigint>
    ];
}
export function assertIsValidAmount(options: AssertIsValidAmountOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/coupons';
    const argumentsTypes = [
        'u8',
        'u64'
...
export interface AssertCouponValidForDomainSizeOptions {
    package?: string;
    arguments: AssertCouponValidForDomainSizeArguments | [
        rules: TransactionArgument,
        length: RawTransactionArgument<number>
    ];
}
export function assertCouponValidForDomainSize(options: AssertCouponValidForDomainSizeOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/coupons';
    const argumentsTypes = [
        null,
        'u8'
...
export interface IsCouponValidForDomainSizeOptions {
    package?: string;
    arguments: IsCouponValidForDomainSizeArguments | [
        rules: TransactionArgument,
        length: RawTransactionArgument<number>
    ];
}
/** We check the length of the name based on the domain length rule */
export function isCouponValidForDomainSize(options: IsCouponValidForDomainSizeOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/coupons';
    const argumentsTypes = [
        null,
        'u8'
...
export interface AssertCouponValidForAddressOptions {
    package?: string;
    arguments: AssertCouponValidForAddressArguments | [
        rules: TransactionArgument,
        user: RawTransactionArgument<string>
    ];
}
/** Throws `EInvalidUser` error if it has expired. */
export function assertCouponValidForAddress(options: AssertCouponValidForAddressOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/coupons';
    const argumentsTypes = [
        null,
        'address'
...
export interface IsCouponValidForAddressOptions {
    package?: string;
    arguments: IsCouponValidForAddressArguments | [
        rules: TransactionArgument,
        user: RawTransactionArgument<string>
    ];
}
/** Check that the domain is valid for the specified address */
export function isCouponValidForAddress(options: IsCouponValidForAddressOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/coupons';
    const argumentsTypes = [
        null,
        'address'
...
export interface AssertCouponIsNotExpiredOptions {
    package?: string;
    arguments: AssertCouponIsNotExpiredArguments | [
        rules: TransactionArgument
    ];
}
/**
 ...
 * has expired.
 */
export function assertCouponIsNotExpired(options: AssertCouponIsNotExpiredOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/coupons';
    const argumentsTypes = [
        null,
        '0x2::clock::Clock'
...
export interface IsCouponExpiredOptions {
    package?: string;
    arguments: IsCouponExpiredArguments | [
        rules: TransactionArgument
    ];
}
/** Check whether a coupon has expired */
export function isCouponExpired(options: IsCouponExpiredOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/coupons';
    const argumentsTypes = [
        null,
        '0x2::clock::Clock'
