...
keywords:
  ...
  - send_funds
questions:
  - How do I coins and balances in Sui dApp Kit?
  - What is the Coins and Balances action?
  - How do I use Coins and Balances?
answer: Work with coin objects and address balances in transactions
goal:
  description: Reader can use Coins and Balances in their application
  requires:
    - has_frontmatter:
        - title
        - description
