...
keywords:
  ...
  - upgrade
questions:
  - How do I commands and inputs reference in Sui dApp Kit?
  - What is the Commands and Inputs Reference action?
  - How do I use Commands and Inputs Reference?
answer: Complete reference for transaction commands and input types
goal:
  description: Reader can use Commands and Inputs Reference in their application
  requires:
    - has_frontmatter:
        - title
        - description
