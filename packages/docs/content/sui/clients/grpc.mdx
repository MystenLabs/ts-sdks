...
keywords: [SuiGrpcClient, gRPC, Sui client, full node, TypeScript SDK, Core API, @mysten/sui, protocol buffers]
---
...
[protobuf-ts](https://github.com/timostamm/protobuf-ts), which works in browsers and Node.js through the
