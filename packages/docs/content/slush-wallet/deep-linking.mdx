---
title: Deep Linking
description: Configure deep links to open Slush Wallet directly to specific screens or actions.
keywords: [deep linking, Slush Wallet, universal links, URL scheme, mobile, Sui, app links]
---
...
<Callout>The URL must be a complete, valid URL including the protocol (for example, `https://`).</Callout>
...
3. **iOS Universal Links**: Must be clicked from Safari or apps that support Universal Links;
   copied or pasted URLs might not trigger the app
