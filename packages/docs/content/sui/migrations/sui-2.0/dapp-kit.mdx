...
keywords: [migration, @mysten/dapp-kit, dapp-kit-react, 2.0, React, framework-agnostic, hooks, breaking changes]
---
...
automatically infer the correct types based on your configuration (for example, your specific networks and
client type).
...
In the old dApp kit, you could optionally pass a `chain` parameter (for example, `sui:mainnet`) to methods
