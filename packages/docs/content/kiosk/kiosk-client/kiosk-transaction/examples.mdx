---
title: Examples
description: Practical code examples for kiosk transactions including minting, listing, and purchasing.
keywords: [kiosk examples, minting, listing, KioskTransaction, Sui, TypeScript, NFT]
---
