...
title: Cryptography
description: >-
  Sign and verify Sui transactions and messages with keypairs and external
  signers
keywords:
  - cryptography
  - signing
...
answer: >-
  The Sui SDK supports Ed25519, Secp256k1, and Secp256r1 keypairs, plus external
  signers (AWS KMS, GCP KMS, Ledger, WebCrypto, Passkey) through a unified
  Signer interface.
goal:
  description: >-
    Reader understands the cryptographic primitives available in the Sui SDK for
