...
export function setThreeCharPrice(
	options: SetThreeCharPriceOptions,
...
export function setFourCharPrice(
	options: SetFourCharPriceOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/core';
	const argumentsTypes = [null, 'u64'] satisfies (string | null)[];
	return (tx: Transaction) =>
...
export function setFivePlusCharPrice(
	options: SetFivePlusCharPriceOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/core';
	const argumentsTypes = [null, 'u64'] satisfies (string | null)[];
	return (tx: Transaction) =>
...
export function threeCharPrice(
	options: ThreeCharPriceOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/core';
	const argumentsTypes = [null] satisfies (string | null)[];
	const parameterNames = ['_'];
...
export function fourCharPrice(
	options: FourCharPriceOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/core';
	const argumentsTypes = [null] satisfies (string | null)[];
	const parameterNames = ['_'];
...
export function fivePlusCharPrice(
