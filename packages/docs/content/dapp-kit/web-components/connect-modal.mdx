---
title: Connect Modal
description: Framework-agnostic web component for wallet selection and connection in Sui dApps.
keywords: [connect modal, web component, wallet selection, framework-agnostic, dApp Kit, Sui, custom element]
---
