...
export const Volumes: MoveStruct<{
    "total_volume": ReturnType<typeof bcs.u128>;
    "total_staked_volume": ReturnType<typeof bcs.u128>;
    "total_fees_collected": typeof balances.Balances;
    "historic_median": ReturnType<typeof bcs.u128>;
    "trade_params": typeof trade_params.TradeParams;
}> = new MoveStruct({ name: `${$moduleName}::Volumes`, fields: {
...
export const History: MoveStruct<{
    "epoch": ReturnType<typeof bcs.u64>;
    "epoch_created": ReturnType<typeof bcs.u64>;
    "volumes": typeof Volumes;
    "historic_volumes": typeof table.Table;
    "balance_to_burn": ReturnType<typeof bcs.u64>;
}> = new MoveStruct({ name: `${$moduleName}::History`, fields: {
        epoch: bcs.u64(),
...
export const EpochData: MoveStruct<{
    "epoch": ReturnType<typeof bcs.u64>;
    "pool_id": typeof bcs.Address;
    "total_volume": ReturnType<typeof bcs.u128>;
    "total_staked_volume": ReturnType<typeof bcs.u128>;
    "base_fees_collected": ReturnType<typeof bcs.u64>;
    "quote_fees_collected": ReturnType<typeof bcs.u64>;
    "deep_fees_collected": ReturnType<typeof bcs.u64>;
    "historic_median": ReturnType<typeof bcs.u128>;
    "taker_fee": ReturnType<typeof bcs.u64>;
    "maker_fee": ReturnType<typeof bcs.u64>;
    "stake_required": ReturnType<typeof bcs.u64>;
}> = new MoveStruct({ name: `${$moduleName}::EpochData`, fields: {
        epoch: bcs.u64(),
        pool_id: bcs.Address,
        total_volume: bcs.u128(),
        total_staked_volume: bcs.u128(),
