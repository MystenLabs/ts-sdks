...
keywords:
  ...
  - intents
questions:
  - How do I migrate Migrate to 1.0?
  - What changed in Migrate to 1.0?
  - What are the breaking changes in Migrate to 1.0?
answer: Migrate to Sui TypeScript SDK 1.0 with new features and API changes.
goal:
  description: Reader can migrate their code to Migrate to 1.0
  requires:
    - has_frontmatter:
        - title
        - description
