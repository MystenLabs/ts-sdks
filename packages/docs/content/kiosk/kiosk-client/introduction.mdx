...
title: Kiosk Client
description: >-
  Introduction to the KioskClient extension for querying and managing kiosks on
  Sui
keywords:
  - KioskClient
  - kiosk extension
...
goal:
  description: >-
    Reader understands introduction to the KioskClient extension for querying
    and managing kiosks on Sui
  requires:
    - has_frontmatter:
        - title
        - description
