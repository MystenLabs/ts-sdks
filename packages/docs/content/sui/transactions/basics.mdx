...
keywords:
  ...
  - codegen
questions:
  - How do I building transactions in Sui dApp Kit?
  - What is the Building Transactions action?
  - How do I use Building Transactions?
answer: Construct programmable transaction blocks with the Transaction API
goal:
  description: Reader can use Building Transactions in their application
  requires:
    - has_frontmatter:
        - title
        - description
