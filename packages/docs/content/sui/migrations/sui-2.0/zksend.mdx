...
keywords:
  ...
  - breaking changes
questions:
  - How do I migrate @mysten/zksend?
  - What changed in @mysten/zksend?
  - What are the breaking changes in @mysten/zksend?
answer: Migrate @mysten/zksend to 2.0 with client extension pattern and simplified API
goal:
  description: Reader can migrate their code to @mysten/zksend
  requires:
    - has_frontmatter:
        - title
        - description
