...
export function _new(options: NewOptions): (tx: Transaction) => TransactionResult {
    ...
    const parameterNames = ["suins", "subdomain", "subdomainName", "expirationTimestampMs", "allowCreation", "allowTimeExtension"];
...
export interface RemoveLeafOptions {
    package?: string;
    arguments: RemoveLeafArguments | [
        suins: RawTransactionArgument<string>,
        subdomain: RawTransactionArgument<string>,
        subdomainName: RawTransactionArgument<string>
    ];
}
export function removeLeaf(options: RemoveLeafOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/subdomain-proxy';
    const argumentsTypes = [
        null,
        null,
...
export interface AddLeafMetadataOptions {
    package?: string;
    arguments: AddLeafMetadataArguments | [
        suins: RawTransactionArgument<string>,
        parent: RawTransactionArgument<string>,
        subdomainName: RawTransactionArgument<string>,
        key: RawTransactionArgument<string>,
...
export function addLeafMetadata(options: AddLeafMetadataOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/subdomain-proxy';
    const argumentsTypes = [
        null,
        null,
...
export interface RemoveLeafMetadataOptions {
    package?: string;
    arguments: RemoveLeafMetadataArguments | [
        suins: RawTransactionArgument<string>,
        parent: RawTransactionArgument<string>,
        subdomainName: RawTransactionArgument<string>,
        key: RawTransactionArgument<string>
...
export function removeLeafMetadata(options: RemoveLeafMetadataOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/subdomain-proxy';
    const argumentsTypes = [
        null,
        null,
...
export function editSetup(options: EditSetupOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/subdomain-proxy';
    const argumentsTypes = [
        null,
        null,
    ...
    const parameterNames = ["suins", "parent", "subdomainName", "allowCreation", "allowTimeExtension"];
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'subdomain_proxy',
        function: 'edit_setup',
