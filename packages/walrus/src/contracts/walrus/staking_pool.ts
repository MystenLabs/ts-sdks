...
const _NewEpochCommissionBlockedForCollectionFields = {
	dummy_field: bcs.bool(),
};
export const NewEpochCommissionBlockedForCollection: MoveStruct<
	typeof _NewEpochCommissionBlockedForCollectionFields
> = new MoveStruct({
	name: `${$moduleName}::NewEpochCommissionBlockedForCollection`,
	fields: _NewEpochCommissionBlockedForCollectionFields,
});
const _VotingParamsFields = {
...
export const VotingParams: MoveStruct<typeof _VotingParamsFields> = new MoveStruct({
	name: `${$moduleName}::VotingParams`,
	fields: _VotingParamsFields,
});
const _PoolStateFields = {
	Active: null,
	Withdrawing: bcs.u32(),
	Withdrawn: null,
};
/** Represents the state of the staking pool. */
export const PoolState: MoveEnum<typeof _PoolStateFields> = new MoveEnum({
	name: `${$moduleName}::PoolState`,
	fields: _PoolStateFields,
});
const _StakingPoolFields = {
	id: bcs.Address,
...
export const StakingPool: MoveStruct<typeof _StakingPoolFields> = new MoveStruct({
	name: `${$moduleName}::StakingPool`,
	fields: _StakingPoolFields,
});
