...
The Sui dApp Kit Next is a framework-agnostic toolkit for building dApps on the Sui blockchain. It
...
[Getting Started](./dapp-kit-next/getting-started) page or check the following the
framework-specific guides:

- [React Guide](./dapp-kit-next/framework-guides/react/getting-started)
- [Vue Guide](./dapp-kit-next/framework-guides/vue)
- [Next Guide](./dapp-kit-next/framework-guides/vue)

## Using Web Components for UI

The dApp Kit Next provides Web Components that work with any framework. These components are built
