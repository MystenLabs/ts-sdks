...
The name of the default payment registry provided by Payment Kit.
...
- [Payment Processing](./payment-processing) - Understanding payment models
- [Examples](./examples) - Real-world code examples
- [Registry Management](./registry-management) - Configure registries
