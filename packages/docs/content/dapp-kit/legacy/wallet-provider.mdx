...
description: React context provider for wallet connections in legacy dApp Kit.
keywords:
  - WalletProvider
  - React provider
  - wallet connection
...
questions:
  ...
  - How do I use WalletProvider?
answer: React context provider for wallet connections in legacy dApp Kit.
goal:
  description: >-
    Reader can use the React context provider for wallet connections in legacy dApp Kit
  requires:
    - has_frontmatter:
        - title
        - description
