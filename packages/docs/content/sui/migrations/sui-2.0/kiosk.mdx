...
title: '@mysten/kiosk'
description: >-
  Migrate @mysten/kiosk to 2.0 with client extension pattern and
  KioskTransaction
keywords:
  - migration
  - mysten/kiosk
  ...
  - breaking changes
questions:
  - How do I migrate @mysten/kiosk?
  - What changed in @mysten/kiosk?
  - What are the breaking changes in @mysten/kiosk?
answer: >-
  Migrate @mysten/kiosk to 2.0 with client extension pattern and
  KioskTransaction
goal:
  description: Reader can migrate their code to @mysten/kiosk
  requires:
    - has_frontmatter:
        - title
        - description
