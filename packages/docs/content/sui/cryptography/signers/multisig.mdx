...
keywords:
  ...
  - TypeScript SDK
questions:
  - How do I use Multi-Signature Transactions?
  - How do I set up Multi-Signature Transactions?
  - What is Multi-Signature Transactions in the Sui SDK?
answer: Create multi-signature transactions with multiple signers on Sui.
goal:
  description: Reader understands and can use Multi-Signature Transactions
  requires:
    - has_frontmatter:
        - title
        - description
