...
description: Sign an arbitrary message with the connected wallet for authentication or proof of ownership.
keywords: [sign message, personal message, dApp Kit, authentication, wallet, Sui, cryptographic signature]
---
