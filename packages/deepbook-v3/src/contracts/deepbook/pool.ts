...
export function createPermissionlessPool(
	options: CreatePermissionlessPoolOptions,
...
export function swapExactBaseForQuote(
	options: SwapExactBaseForQuoteOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
 ...
 */
export function swapExactBaseForQuoteWithManager(
	options: SwapExactBaseForQuoteWithManagerOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [
		null,
...
export function swapExactQuoteForBase(
	options: SwapExactQuoteForBaseOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, null, null, 'u64', '0x2::clock::Clock'] satisfies (string | null)[];
 ...
 * DEEP. Assumes balance manager has enough DEEP for fees.
 */
export function swapExactQuoteForBaseWithManager(
	options: SwapExactQuoteForBaseWithManagerOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [
		null,
...
export function swapExactQuantity(
	options: SwapExactQuantityOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
...
export function swapExactQuantityWithManager(
	options: SwapExactQuantityWithManagerOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [
		null,
 ...
 */
export function cancelLiveOrder(
	options: CancelLiveOrderOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, null, null, 'u128', '0x2::clock::Clock'] satisfies (
		| string
 ...
 * cancelled order.
 */
export function cancelLiveOrders(
	options: CancelLiveOrdersOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, null, null, 'vector<u128>', '0x2::clock::Clock'] satisfies (
		| string
...
export function withdrawSettledAmounts(
	options: WithdrawSettledAmountsOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
 ...
 */
export function borrowFlashloanBase(
	options: BorrowFlashloanBaseOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
 ...
 */
export function borrowFlashloanQuote(
	options: BorrowFlashloanQuoteOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, 'u64'] satisfies (string | null)[];
 ...
 */
export function returnFlashloanBase(
	options: ReturnFlashloanBaseOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, null, null] satisfies (string | null)[];
 ...
 * unwrapped if the assets are returned, otherwise the transaction will fail.
 */
export function returnFlashloanQuote(
	options: ReturnFlashloanQuoteOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, null, null] satisfies (string | null)[];
	const parameterNames = ['self', 'coin', 'flashLoan'];
...
export function addDeepPricePoint(
	options: AddDeepPricePointOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
...
export function updateReferralMultiplier(
	options: UpdateReferralMultiplierOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
...
export function updateDeepbookReferralMultiplier(
	options: UpdateDeepbookReferralMultiplierOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, null, 'u64'] satisfies (string | null)[];
	const parameterNames = ['Self', 'Referral', 'Multiplier'];
...
export function updatePoolReferralMultiplier(
	options: UpdatePoolReferralMultiplierOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, null, 'u64'] satisfies (string | null)[];
	const parameterNames = ['self', 'referral', 'multiplier'];
...
export function claimReferralRewards(
	options: ClaimReferralRewardsOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, null] satisfies (string | null)[];
...
export function claimPoolReferralRewards(
	options: ClaimPoolReferralRewardsOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, null] satisfies (string | null)[];
	const parameterNames = ['self', 'referral'];
 ...
 * pool created
 */
export function createPoolAdmin(
	options: CreatePoolAdminOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
...
export function unregisterPoolAdmin(
	options: UnregisterPoolAdminOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, null, null] satisfies (string | null)[];
 ...
 */
export function updateAllowedVersions(
	options: UpdateAllowedVersionsOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, null, null] satisfies (string | null)[];
	const parameterNames = ['self', 'registry', 'Cap'];
 ...
 * restrictions
 */
export function updatePoolAllowedVersions(
	options: UpdatePoolAllowedVersionsOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, null] satisfies (string | null)[];
...
export function adjustTickSizeAdmin(
	options: AdjustTickSizeAdminOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
 ...
 */
export function adjustMinLotSizeAdmin(
	options: AdjustMinLotSizeAdminOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
 ...
 */
export function enableEwmaState(
	options: EnableEwmaStateOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
...
export function setEwmaParams(
	options: SetEwmaParamsOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
...
export function registeredPool(
	options: RegisteredPoolOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null] satisfies (string | null)[];
	const parameterNames = ['self'];
 ...
 * token as fee.
 */
export function getQuoteQuantityOut(
	options: GetQuoteQuantityOutOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
 ...
 * token as fee.
 */
export function getBaseQuantityOut(
	options: GetBaseQuantityOutOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, 'u64', '0x2::clock::Clock'] satisfies (string | null)[];
 ...
 * input token as fee.
 */
export function getQuoteQuantityOutInputFee(
	options: GetQuoteQuantityOutInputFeeOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, 'u64', '0x2::clock::Clock'] satisfies (string | null)[];
	const parameterNames = ['self', 'baseQuantity'];
 ...
 * input token as fee.
 */
export function getBaseQuantityOutInputFee(
	options: GetBaseQuantityOutInputFeeOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, 'u64', '0x2::clock::Clock'] satisfies (string | null)[];
	const parameterNames = ['self', 'quoteQuantity'];
 ...
 * as fee.
 */
export function getQuantityOut(
	options: GetQuantityOutOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
 ...
 * as fee.
 */
export function getQuantityOutInputFee(
	options: GetQuantityOutInputFeeOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, 'u64', 'u64', '0x2::clock::Clock'] satisfies (string | null)[];
	const parameterNames = ['self', 'baseQuantity', 'quoteQuantity'];
 ...
 */
export function getBaseQuantityIn(
	options: GetBaseQuantityInOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
 ...
 * min_size.
 */
export function getQuoteQuantityIn(
	options: GetQuoteQuantityInOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, 'u64', 'bool', '0x2::clock::Clock'] satisfies (string | null)[];
...
export function accountOpenOrders(
	options: AccountOpenOrdersOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, null] satisfies (string | null)[];
	const parameterNames = ['self', 'balanceManager'];
 ...
 */
export function getLevel2Range(
	options: GetLevel2RangeOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
 ...
 * for asks.
 */
export function getLevel2TicksFromMid(
	options: GetLevel2TicksFromMidOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, 'u64', '0x2::clock::Clock'] satisfies (string | null)[];
...
export function getPoolIdByAsset(
	options: GetPoolIdByAssetOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null] satisfies (string | null)[];
...
export function getAccountOrderDetails(
	options: GetAccountOrderDetailsOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, null] satisfies (string | null)[];
	const parameterNames = ['self', 'balanceManager'];
...
export function getOrderDeepPrice(
	options: GetOrderDeepPriceOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null] satisfies (string | null)[];
	const parameterNames = ['self'];
 ...
 * deep_required_maker)
 */
export function getOrderDeepRequired(
	options: GetOrderDeepRequiredOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
...
export function canPlaceLimitOrder(
	options: CanPlaceLimitOrderOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [
		null,
 ...
 */
export function canPlaceMarketOrder(
	options: CanPlaceMarketOrderOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
 ...
 */
export function checkMarketOrderParams(
	options: CheckMarketOrderParamsOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, 'u64'] satisfies (string | null)[];
 ...
 * the order parameters are valid, false otherwise.
 */
export function checkLimitOrderParams(
	options: CheckLimitOrderParamsOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
 ...
 * stake_required)
 */
export function poolTradeParams(
	options: PoolTradeParamsOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null] satisfies (string | null)[];
	const parameterNames = ['self'];
...
export function poolTradeParamsNext(
	options: PoolTradeParamsNextOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null] satisfies (string | null)[];
	const parameterNames = ['self'];
...
export function poolBookParams(
	options: PoolBookParamsOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null] satisfies (string | null)[];
	const parameterNames = ['self'];
...
export function getReferralBalances(
	options: GetReferralBalancesOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, null] satisfies (string | null)[];
	const parameterNames = ['Self', 'Referral'];
...
export function getPoolReferralBalances(
	options: GetPoolReferralBalancesOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, null] satisfies (string | null)[];
	const parameterNames = ['self', 'referral'];
...
export function poolReferralMultiplier(
	options: PoolReferralMultiplierOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, null] satisfies (string | null)[];
	const parameterNames = ['self', 'referral'];
