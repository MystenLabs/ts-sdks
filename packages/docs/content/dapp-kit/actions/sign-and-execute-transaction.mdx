...
keywords:
  ...
  - transfer
questions:
  - How do I sign and execute transaction in Sui dApp Kit?
  - What is the Sign and Execute Transaction action?
  - How do I use Sign and Execute Transaction?
answer: Sign and execute a transaction on the Sui network using the connected wallet.
goal:
  description: Reader can use Sign and Execute Transaction in their application
  requires:
    - has_frontmatter:
        - title
        - description
