...
description: >-
  Legacy React hook to check the auto-connection status for the last connected
  wallet.
keywords:
...
goal:
  description: >-
    Reader can use the legacy React hook to check the auto-connection status for
    the last connected wallet
  requires:
    - has_frontmatter:
        - title
        - description
