...
keywords: [Hello Sui, tutorial, getting started, TypeScript SDK, Sui, faucet, Node.js, beginner]
---
...
You need an address on a Sui development network (Devnet, Testnet, or local). If you don't already have
