...
export const RegularDiscountsApp: MoveTuple<[
    ReturnType<typeof bcs.bool>
]> = new MoveTuple({ name: `${$moduleName}::RegularDiscountsApp`, fields: [bcs.bool()] });
export const DiscountKey: MoveTuple<[
    ReturnType<typeof bcs.bool>
]> = new MoveTuple({ name: `${$moduleName}::DiscountKey<phantom T>`, fields: [bcs.bool()] });
...
export interface ApplyPercentageDiscountOptions<T extends BcsType<any>> {
    package?: string;
    arguments: ApplyPercentageDiscountArguments<T> | [
        self: RawTransactionArgument<string>,
        intent: TransactionArgument,
        suins: RawTransactionArgument<string>,
        _: RawTransactionArgument<T>
...
export function applyPercentageDiscount<T extends BcsType<any>>(options: ApplyPercentageDiscountOptions<T>): (tx: Transaction) => TransactionResult {
...
export interface ApplyDayOneDiscountOptions {
    package?: string;
    arguments: ApplyDayOneDiscountArguments | [
        self: RawTransactionArgument<string>,
        intent: TransactionArgument,
        suins: RawTransactionArgument<string>,
        dayOne: RawTransactionArgument<string>
 ...
 */
export function applyDayOneDiscount(options: ApplyDayOneDiscountOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/discounts';
    const argumentsTypes = [
        null,
        null,
