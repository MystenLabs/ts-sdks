...
title: '@mysten/sui'
description: >-
  Migrate @mysten/sui from 1.x to 2.0 with gRPC clients, Core API, and BCS
  changes
keywords:
  - migration
  - '@mysten/sui'
  ...
  - breaking changes
questions:
  - How do I migrate @mysten/sui?
  - What changed in @mysten/sui?
  - What are the breaking changes in @mysten/sui?
answer: >-
  Migrate @mysten/sui from 1.x to 2.0 with gRPC clients, Core API, and BCS
  changes
goal:
  description: Reader can migrate their code to @mysten/sui
  requires:
    - has_frontmatter:
        - title
        - description
