...
**Default Registry Name**: `'default-payment-registry'`
...
- [Payment Processing](./payment-processing) - Learn how to process payments with your registry
- [Examples](./examples) - See complete registry workflows
