...
keywords:
  ...
  - mobile wallet
questions:
  - What is Slush Integration?
  - How do I use Slush Integration?
  - How does Setup work?
answer: Integrate Slush wallet with the legacy dApp Kit WalletProvider.
goal:
  description: Reader can integrate Slush wallet with the legacy dApp Kit WalletProvider
  requires:
    - has_frontmatter:
        - title
        - description
