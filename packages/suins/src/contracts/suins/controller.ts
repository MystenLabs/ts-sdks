...
export const ControllerV2: MoveTuple<[ReturnType<typeof bcs.bool>]> = new MoveTuple({
...
export function setReverseLookup(
	options: SetReverseLookupOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/core';
...
export function unsetReverseLookup(
	options: UnsetReverseLookupOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/core';
 ...
 */
export function setObjectReverseLookup(
	options: SetObjectReverseLookupOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/core';
 ...
 * reference of the object.
 */
export function unsetObjectReverseLookup(
	options: UnsetObjectReverseLookupOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/core';
...
export function burnExpiredSubname(
	options: BurnExpiredSubnameOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/core';
	const argumentsTypes = [null, null, '0x2::clock::Clock'] satisfies (string | null)[];
	const parameterNames = ['suins', 'nft'];
 ...
 * subdomain NFT.
 */
export function pruneExpiredSubname(
	options: PruneExpiredSubnameOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/core';
	const argumentsTypes = [null, null, '0x1::string::String', '0x2::clock::Clock'] satisfies (
		| string
 ...
 */
export function pruneExpiredSubnames(
	options: PruneExpiredSubnamesOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/core';
	const argumentsTypes = [
		null,
