...
- `chain`: (optional) The chain identifier the message should be signed for. This is useful when
  signing messages for zkLogin accounts which rely on a network-bound zero knowledge proof to obtain
