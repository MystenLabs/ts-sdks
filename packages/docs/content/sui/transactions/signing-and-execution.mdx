...
answer: >-
  Sign transactions with a Keypair or Signer, then execute them via a Sui
  client. The SDK supports signing and executing in one step or separately for
  sponsored/multisig flows.
goal:
