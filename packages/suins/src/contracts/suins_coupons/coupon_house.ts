...
export function registerWithCoupon(
	options: RegisterWithCouponOptions,
...
export function calculateSalePrice(
	options: CalculateSalePriceOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/coupons';
...
export function appDataMut<A extends BcsType<any>>(
	options: AppDataMutOptions<A>,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/coupons';
...
export function assertVersionIsValid(
	options: AssertVersionIsValidOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/coupons';
...
export function adminRemoveCoupon(
	options: AdminRemoveCouponOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/coupons';
...
export function appRemoveCoupon(
	options: AppRemoveCouponOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@suins/coupons';
