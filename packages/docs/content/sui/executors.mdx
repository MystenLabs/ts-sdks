...
keywords:
  ...
  - TypeScript SDK
questions:
  - What is Transaction Executors?
  - How do I use Transaction Executors?
  - How does Transaction Executors work?
answer: Manage transaction execution with queuing and parallel strategies
goal:
  description: Reader understands and can use Transaction Executors
  requires:
    - has_frontmatter:
        - title
        - description
