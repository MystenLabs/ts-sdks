...
| `initialize()`                | Load previously imported accounts from localStorage |
| `listAvailableAccounts()`     | Fetch all accounts from the CLI keystore            |
...
| `destroy()`                   | Clean up and clear stored tokens                    |
