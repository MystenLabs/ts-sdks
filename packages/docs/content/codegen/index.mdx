...
keywords:
  ...
  - BCS
questions:
  - What is Sui TypeScript Codegen?
  - How do I get started with Sui TypeScript Codegen?
  - How do I install Sui TypeScript Codegen?
answer: Generate type-safe TypeScript bindings from onchain Sui Move packages.
goal:
  description: >-
    Reader understands what Sui TypeScript Codegen is, how to install it, and
