...
keywords: [zkSend, link builder, claim links, create link, asset transfer, Sui, TypeScript]
---
...
- **`coinType`** (required) - The coin type of the coin to add to the link (for example, `0x2::sui::SUI`).
