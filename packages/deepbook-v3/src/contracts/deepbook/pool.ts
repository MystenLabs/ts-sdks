...
export const Pool: MoveStruct<{
    "id": typeof bcs.Address;
    "inner": typeof versioned.Versioned;
}> = new MoveStruct({ name: `${$moduleName}::Pool<phantom BaseAsset, phantom QuoteAsset>`, fields: {
        id: bcs.Address,
        inner: versioned.Versioned
    } });
export const PoolInner: MoveStruct<{
    "allowed_versions": ReturnType<typeof vec_set.VecSet<ReturnType<typeof bcs.u64>>>;
    "pool_id": typeof bcs.Address;
    "book": typeof book.Book;
    "state": typeof state.State;
    "vault": typeof vault.Vault;
    "deep_price": typeof deep_price.DeepPrice;
    "registered_pool": ReturnType<typeof bcs.bool>;
}> = new MoveStruct({ name: `${$moduleName}::PoolInner<phantom BaseAsset, phantom QuoteAsset>`, fields: {
...
export const PoolCreated: MoveStruct<{
    "pool_id": typeof bcs.Address;
    "taker_fee": ReturnType<typeof bcs.u64>;
    "maker_fee": ReturnType<typeof bcs.u64>;
    "tick_size": ReturnType<typeof bcs.u64>;
    "lot_size": ReturnType<typeof bcs.u64>;
    "min_size": ReturnType<typeof bcs.u64>;
    "whitelisted_pool": ReturnType<typeof bcs.bool>;
    "treasury_address": typeof bcs.Address;
}> = new MoveStruct({ name: `${$moduleName}::PoolCreated<phantom BaseAsset, phantom QuoteAsset>`, fields: {
        pool_id: bcs.Address,
        taker_fee: bcs.u64(),
        maker_fee: bcs.u64(),
        tick_size: bcs.u64(),
...
export const BookParamsUpdated: MoveStruct<{
    "pool_id": typeof bcs.Address;
    "tick_size": ReturnType<typeof bcs.u64>;
    "lot_size": ReturnType<typeof bcs.u64>;
    "min_size": ReturnType<typeof bcs.u64>;
    "timestamp": ReturnType<typeof bcs.u64>;
}> = new MoveStruct({ name: `${$moduleName}::BookParamsUpdated<phantom BaseAsset, phantom QuoteAsset>`, fields: {
        pool_id: bcs.Address,
        tick_size: bcs.u64(),
        lot_size: bcs.u64(),
        min_size: bcs.u64(),
...
export const DeepBurned: MoveStruct<{
    "pool_id": typeof bcs.Address;
    "deep_burned": ReturnType<typeof bcs.u64>;
}> = new MoveStruct({ name: `${$moduleName}::DeepBurned<phantom BaseAsset, phantom QuoteAsset>`, fields: {
        pool_id: bcs.Address,
        deep_burned: bcs.u64()
    } });
export const ReferralRewards: MoveStruct<{
    "multiplier": ReturnType<typeof bcs.u64>;
    "base": typeof balance.Balance;
    "quote": typeof balance.Balance;
    "deep": typeof balance.Balance;
}> = new MoveStruct({ name: `${$moduleName}::ReferralRewards<phantom BaseAsset, phantom QuoteAsset>`, fields: {
        multiplier: bcs.u64(),
        base: balance.Balance,
        quote: balance.Balance,
        deep: balance.Balance
    } });
export const ReferralClaimedEvent: MoveStruct<{
    "referral_id": typeof bcs.Address;
    "owner": typeof bcs.Address;
    "base_amount": ReturnType<typeof bcs.u64>;
    "quote_amount": ReturnType<typeof bcs.u64>;
    "deep_amount": ReturnType<typeof bcs.u64>;
}> = new MoveStruct({ name: `${$moduleName}::ReferralClaimedEvent<phantom BaseAsset, phantom QuoteAsset>`, fields: {
...
export const ReferralClaimed: MoveStruct<{
    "pool_id": typeof bcs.Address;
    "referral_id": typeof bcs.Address;
    "owner": typeof bcs.Address;
    "base_amount": ReturnType<typeof bcs.u64>;
    "quote_amount": ReturnType<typeof bcs.u64>;
    "deep_amount": ReturnType<typeof bcs.u64>;
}> = new MoveStruct({ name: `${$moduleName}::ReferralClaimed`, fields: {
        pool_id: bcs.Address,
        referral_id: bcs.Address,
        owner: bcs.Address,
        base_amount: bcs.u64(),
...
export const ReferralFeeEvent: MoveStruct<{
    "pool_id": typeof bcs.Address;
    "referral_id": typeof bcs.Address;
    "base_fee": ReturnType<typeof bcs.u64>;
    "quote_fee": ReturnType<typeof bcs.u64>;
    "deep_fee": ReturnType<typeof bcs.u64>;
}> = new MoveStruct({ name: `${$moduleName}::ReferralFeeEvent`, fields: {
        pool_id: bcs.Address,
        referral_id: bcs.Address,
        base_fee: bcs.u64(),
        quote_fee: bcs.u64(),
 ...
 */
export function createPermissionlessPool(options: CreatePermissionlessPoolOptions): (tx: Transaction) => TransactionResult {
 ...
 */
export function placeLimitOrder(options: PlaceLimitOrderOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
    ...
    const parameterNames = ["self", "balanceManager", "tradeProof", "clientOrderId", "orderType", "selfMatchingOption", "price", "quantity", "isBid", "payWithDeep", "expireTimestamp"];
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'pool',
 ...
 * filled is cancelled.
 */
export function placeMarketOrder(options: PlaceMarketOrderOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
    ...
    const parameterNames = ["self", "balanceManager", "tradeProof", "clientOrderId", "selfMatchingOption", "quantity", "isBid", "payWithDeep"];
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'pool',
 ...
 */
export function swapExactBaseForQuote(options: SwapExactBaseForQuoteOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
...
export interface SwapExactBaseForQuoteWithManagerOptions {
    package?: string;
    arguments: SwapExactBaseForQuoteWithManagerArguments | [
        self: RawTransactionArgument<string>,
        balanceManager: RawTransactionArgument<string>,
        tradeCap: RawTransactionArgument<string>,
        depositCap: RawTransactionArgument<string>,
 ...
 */
export function swapExactBaseForQuoteWithManager(options: SwapExactBaseForQuoteWithManagerOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
    ...
    const parameterNames = ["self", "balanceManager", "tradeCap", "depositCap", "withdrawCap", "baseIn", "minQuoteOut"];
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'pool',
 ...
 * size.
 */
export function swapExactQuoteForBase(options: SwapExactQuoteForBaseOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
...
export interface SwapExactQuoteForBaseWithManagerOptions {
    package?: string;
    arguments: SwapExactQuoteForBaseWithManagerArguments | [
        self: RawTransactionArgument<string>,
        balanceManager: RawTransactionArgument<string>,
        tradeCap: RawTransactionArgument<string>,
        depositCap: RawTransactionArgument<string>,
 ...
 * DEEP. Assumes balance manager has enough DEEP for fees.
 */
export function swapExactQuoteForBaseWithManager(options: SwapExactQuoteForBaseWithManagerOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
    ...
    const parameterNames = ["self", "balanceManager", "tradeCap", "depositCap", "withdrawCap", "quoteIn", "minBaseOut"];
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'pool',
...
export function swapExactQuantity(options: SwapExactQuantityOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
...
export interface SwapExactQuantityWithManagerOptions {
    package?: string;
    arguments: SwapExactQuantityWithManagerArguments | [
        self: RawTransactionArgument<string>,
        balanceManager: RawTransactionArgument<string>,
        tradeCap: RawTransactionArgument<string>,
        depositCap: RawTransactionArgument<string>,
 ...
 */
export function swapExactQuantityWithManager(options: SwapExactQuantityWithManagerOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
    ...
    const parameterNames = ["self", "balanceManager", "tradeCap", "depositCap", "withdrawCap", "baseIn", "quoteIn", "minOut"];
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'pool',
 ...
 */
export function modifyOrder(options: ModifyOrderOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
 ...
 */
export function cancelOrder(options: CancelOrderOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
 ...
 */
export function cancelOrders(options: CancelOrdersOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
 ...
 */
export function cancelLiveOrder(options: CancelLiveOrderOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
 ...
 * cancelled order.
 */
export function cancelLiveOrders(options: CancelLiveOrdersOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
...
export function cancelAllOrders(options: CancelAllOrdersOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
...
export function withdrawSettledAmounts(options: WithdrawSettledAmountsOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
...
export function withdrawSettledAmountsPermissionless(options: WithdrawSettledAmountsPermissionlessOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null
 ...
 */
export function stake(options: StakeOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
 ...
 */
export function unstake(options: UnstakeOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
 ...
 */
export function submitProposal(options: SubmitProposalOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
 ...
 */
export function vote(options: VoteOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
 ...
 */
export function claimRebates(options: ClaimRebatesOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
 ...
 */
export function borrowFlashloanBase(options: BorrowFlashloanBaseOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        'u64'
 ...
 */
export function borrowFlashloanQuote(options: BorrowFlashloanQuoteOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        'u64'
 ...
 */
export function returnFlashloanBase(options: ReturnFlashloanBaseOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
 ...
 * unwrapped if the assets are returned, otherwise the transaction will fail.
 */
export function returnFlashloanQuote(options: ReturnFlashloanQuoteOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
 ...
 */
export function addDeepPricePoint(options: AddDeepPricePointOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
...
export function burnDeep(options: BurnDeepOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null
...
export interface MintReferralOptions {
    package?: string;
    arguments: MintReferralArguments | [
        self: RawTransactionArgument<string>,
        multiplier: RawTransactionArgument<number | bigint>
    ];
    typeArguments: [
...
export function mintReferral(options: MintReferralOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        'u64'
...
export interface UpdateReferralMultiplierOptions {
    package?: string;
    arguments: UpdateReferralMultiplierArguments | [
        Self: RawTransactionArgument<string>,
        Referral: RawTransactionArgument<string>,
        Multiplier: RawTransactionArgument<number | bigint>
    ];
...
export function updateReferralMultiplier(options: UpdateReferralMultiplierOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
...
export interface UpdateDeepbookReferralMultiplierOptions {
    package?: string;
    arguments: UpdateDeepbookReferralMultiplierArguments | [
        Self: RawTransactionArgument<string>,
        Referral: RawTransactionArgument<string>,
        Multiplier: RawTransactionArgument<number | bigint>
    ];
...
export function updateDeepbookReferralMultiplier(options: UpdateDeepbookReferralMultiplierOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
...
export interface UpdatePoolReferralMultiplierOptions {
    package?: string;
    arguments: UpdatePoolReferralMultiplierArguments | [
        self: RawTransactionArgument<string>,
        referral: RawTransactionArgument<string>,
        multiplier: RawTransactionArgument<number | bigint>
    ];
...
export function updatePoolReferralMultiplier(options: UpdatePoolReferralMultiplierOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
...
export interface ClaimReferralRewardsOptions {
    package?: string;
    arguments: ClaimReferralRewardsArguments | [
        Self: RawTransactionArgument<string>,
        Referral: RawTransactionArgument<string>
    ];
    typeArguments: [
...
export function claimReferralRewards(options: ClaimReferralRewardsOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null
...
export interface ClaimPoolReferralRewardsOptions {
    package?: string;
    arguments: ClaimPoolReferralRewardsArguments | [
        self: RawTransactionArgument<string>,
        referral: RawTransactionArgument<string>
    ];
    typeArguments: [
...
export function claimPoolReferralRewards(options: ClaimPoolReferralRewardsOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null
 ...
 * pool created
 */
export function createPoolAdmin(options: CreatePoolAdminOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        'u64',
...
export function unregisterPoolAdmin(options: UnregisterPoolAdminOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
 ...
 */
export function updateAllowedVersions(options: UpdateAllowedVersionsOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
 ...
 * restrictions
 */
export function updatePoolAllowedVersions(options: UpdatePoolAllowedVersionsOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null
...
export function adjustTickSizeAdmin(options: AdjustTickSizeAdminOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        'u64',
 ...
 */
export function adjustMinLotSizeAdmin(options: AdjustMinLotSizeAdminOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        'u64',
 ...
 */
export function enableEwmaState(options: EnableEwmaStateOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
...
export function setEwmaParams(options: SetEwmaParamsOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
...
export function whitelisted(options: WhitelistedOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export function stablePool(options: StablePoolOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export function registeredPool(options: RegisteredPoolOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
 ...
 * token as fee.
 */
export function getQuoteQuantityOut(options: GetQuoteQuantityOutOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        'u64',
 ...
 * token as fee.
 */
export function getBaseQuantityOut(options: GetBaseQuantityOutOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        'u64',
 ...
 * input token as fee.
 */
export function getQuoteQuantityOutInputFee(options: GetQuoteQuantityOutInputFeeOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        'u64',
 ...
 * input token as fee.
 */
export function getBaseQuantityOutInputFee(options: GetBaseQuantityOutInputFeeOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        'u64',
 ...
 * as fee.
 */
export function getQuantityOut(options: GetQuantityOutOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        'u64',
 ...
 * as fee.
 */
export function getQuantityOutInputFee(options: GetQuantityOutInputFeeOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        'u64',
...
export interface GetBaseQuantityInOptions {
    package?: string;
    arguments: GetBaseQuantityInArguments | [
        self: RawTransactionArgument<string>,
        targetQuoteQuantity: RawTransactionArgument<number | bigint>,
        payWithDeep: RawTransactionArgument<boolean>
    ];
 ...
 */
export function getBaseQuantityIn(options: GetBaseQuantityInOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        'u64',
...
export interface GetQuoteQuantityInOptions {
    package?: string;
    arguments: GetQuoteQuantityInArguments | [
        self: RawTransactionArgument<string>,
        targetBaseQuantity: RawTransactionArgument<number | bigint>,
        payWithDeep: RawTransactionArgument<boolean>
    ];
 ...
 * min_size.
 */
export function getQuoteQuantityIn(options: GetQuoteQuantityInOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        'u64',
...
export function midPrice(options: MidPriceOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        '0x2::clock::Clock'
...
export function accountOpenOrders(options: AccountOpenOrdersOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null
 ...
 */
export function getLevel2Range(options: GetLevel2RangeOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        'u64',
 ...
 * for asks.
 */
export function getLevel2TicksFromMid(options: GetLevel2TicksFromMidOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        'u64',
...
export function vaultBalances(options: VaultBalancesOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export function getPoolIdByAsset(options: GetPoolIdByAssetOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export function getOrder(options: GetOrderOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        'u128'
...
export function getOrders(options: GetOrdersOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        'vector<u128>'
...
export function getAccountOrderDetails(options: GetAccountOrderDetailsOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null
...
export function getOrderDeepPrice(options: GetOrderDeepPriceOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
 ...
 * deep_required_maker)
 */
export function getOrderDeepRequired(options: GetOrderDeepRequiredOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        'u64',
 ...
 */
export function lockedBalance(options: LockedBalanceOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null
...
export interface CanPlaceLimitOrderOptions {
    package?: string;
    arguments: CanPlaceLimitOrderArguments | [
        self: RawTransactionArgument<string>,
        balanceManager: RawTransactionArgument<string>,
        price: RawTransactionArgument<number | bigint>,
        quantity: RawTransactionArgument<number | bigint>,
 ...
 * worst case scenario.
 */
export function canPlaceLimitOrder(options: CanPlaceLimitOrderOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
    ...
    const parameterNames = ["self", "balanceManager", "price", "quantity", "isBid", "payWithDeep", "expireTimestamp"];
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'pool',
...
export interface CanPlaceMarketOrderOptions {
    package?: string;
    arguments: CanPlaceMarketOrderArguments | [
        self: RawTransactionArgument<string>,
        balanceManager: RawTransactionArgument<string>,
        quantity: RawTransactionArgument<number | bigint>,
        isBid: RawTransactionArgument<boolean>,
 ...
 */
export function canPlaceMarketOrder(options: CanPlaceMarketOrderOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null,
...
export interface CheckMarketOrderParamsOptions {
    package?: string;
    arguments: CheckMarketOrderParamsArguments | [
        self: RawTransactionArgument<string>,
        quantity: RawTransactionArgument<number | bigint>
    ];
    typeArguments: [
 ...
 */
export function checkMarketOrderParams(options: CheckMarketOrderParamsOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        'u64'
...
export interface CheckLimitOrderParamsOptions {
    package?: string;
    arguments: CheckLimitOrderParamsArguments | [
        self: RawTransactionArgument<string>,
        price: RawTransactionArgument<number | bigint>,
        quantity: RawTransactionArgument<number | bigint>,
        expireTimestamp: RawTransactionArgument<number | bigint>
 ...
 * the order parameters are valid, false otherwise.
 */
export function checkLimitOrderParams(options: CheckLimitOrderParamsOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        'u64',
 ...
 * stake_required)
 */
export function poolTradeParams(options: PoolTradeParamsOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export function poolTradeParamsNext(options: PoolTradeParamsNextOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export function poolBookParams(options: PoolBookParamsOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export function accountExists(options: AccountExistsOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null
...
export function account(options: AccountOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null
...
export function quorum(options: QuorumOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export interface GetReferralBalancesOptions {
    package?: string;
    arguments: GetReferralBalancesArguments | [
        Self: RawTransactionArgument<string>,
        Referral: RawTransactionArgument<string>
    ];
    typeArguments: [
...
export function getReferralBalances(options: GetReferralBalancesOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null
...
export interface GetPoolReferralBalancesOptions {
    package?: string;
    arguments: GetPoolReferralBalancesArguments | [
        self: RawTransactionArgument<string>,
        referral: RawTransactionArgument<string>
    ];
    typeArguments: [
...
export function getPoolReferralBalances(options: GetPoolReferralBalancesOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null
...
export interface PoolReferralMultiplierOptions {
    package?: string;
    arguments: PoolReferralMultiplierArguments | [
        self: RawTransactionArgument<string>,
        referral: RawTransactionArgument<string>
    ];
    typeArguments: [
...
export function poolReferralMultiplier(options: PoolReferralMultiplierOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null
