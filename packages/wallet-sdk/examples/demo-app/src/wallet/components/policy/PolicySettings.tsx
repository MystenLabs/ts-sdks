...
interface PolicySettingsProps {
	...
	usdBudget: number;
	suiBudget: string;
	onRemainingTransactionsChange: (value: number) => void;
	onUsdBudgetChange: (value: number) => void;
		...
		<div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
			...
			<div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
				<Input
					...
					onChange={(e) => onRemainingTransactionsChange(Number.parseInt(e.target.value))}
					placeholder="10"
					variant="compact"
				/>
				...
				<Input
					...
					step="0.01"
					value={usdBudget}
					onChange={(e) => onUsdBudgetChange(Number.parseFloat(e.target.value))}
					placeholder="10"
					prefix="$"
					variant="compact"
				/>
