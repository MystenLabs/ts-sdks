---
title: Querying
description: Query kiosk contents, owned kiosks, items, and transfer policies using the Kiosk SDK.
keywords: [kiosk querying, getOwnedKiosks, KioskOwnerCap, kiosk contents, transfer policy, Sui, TypeScript]
---
