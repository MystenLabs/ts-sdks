...
description: Compute derived object IDs from parent objects for deterministic offline derivation.
keywords: [derived objects, deriveObjectID, deterministic IDs, object derivation, Sui, @mysten/sui/utils, offline, parent objects]
---
