...
keywords: [theming, CSS variables, shadcn/ui, dApp Kit, web components, customization, styling]
---
...
- **`--muted`:** Background color for subtle or muted UI elements (for example, placeholders and disabled
  states).
