...
The dApp Kit Next provides an action for wallet connection, allowing users to connect, disconnect, and switch between wallets and accounts.

<Callout>
	The [Connect Button](../web-components/connect-button) Web Component provides a complete wallet connection UI.
</Callout>
