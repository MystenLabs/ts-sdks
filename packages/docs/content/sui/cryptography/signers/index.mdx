...
title: Signers
description: >-
  Signer implementations beyond keypairs — cloud KMS, Ledger, Web Crypto,
  passkeys, and multisig
keywords:
  - signers
  - Signer
  - AWS KMS
  ...
  - TypeScript SDK
questions:
  - How do I use Signers?
  - How do I set up Signers?
  - What is Signers in the Sui SDK?
answer: >-
  Signer implementations beyond keypairs — cloud KMS, Ledger, Web Crypto,
  passkeys, and multisig
goal:
  description: >-
    Reader understands what Signers is, how to install it, and its core
    capabilities
  requires:
    - has_frontmatter:
        - title
