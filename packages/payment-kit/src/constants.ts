...
export const TESTNET_PAYMENT_KIT_PACKAGE_CONFIG: PaymentKitPackageConfig = {
...
export const MAINNET_PAYMENT_KIT_PACKAGE_CONFIG: PaymentKitPackageConfig = {
...
export const SUI_COIN_TYPE: string = normalizeStructTag(SUI_TYPE_ARG);
