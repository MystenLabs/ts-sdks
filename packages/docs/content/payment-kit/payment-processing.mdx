...
description: >-
  Process registry-based and ephemeral payments and handle transaction results
  on Sui.
keywords:
  - payment processing
  - registry payments
...
goal:
  description: >-
    Reader understands process registry-based and ephemeral payments and handle
    transaction results on Sui
  requires:
    - has_frontmatter:
        - title
        - description
