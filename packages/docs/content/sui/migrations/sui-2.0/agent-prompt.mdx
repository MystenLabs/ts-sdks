...
keywords: [AI agent, migration prompt, automated migration, SDK 2.0, Claude Code, Cursor, codebase upgrade]
---

Copy and paste the following prompt into your AI coding assistant (Claude Code, Cursor, and others) to
