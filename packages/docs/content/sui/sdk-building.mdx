...
keywords: [SDK development, ClientWithCoreApi, peer dependencies, Sui TypeScript SDK, client extensions, library authors, transport-agnostic]
---
...
All SDKs should depend on [`ClientWithCoreApi`](./clients/core), which is the
