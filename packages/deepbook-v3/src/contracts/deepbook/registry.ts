...
export function deauthorizeApp(
	options: DeauthorizeAppOptions,
 ...
 * DeepBook.
 */
export function assertAppIsAuthorized(
	options: AssertAppIsAuthorizedOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
...
export function setTreasuryAddress(
	options: SetTreasuryAddressOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
...
export function addStablecoin(
	options: AddStablecoinOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, null] satisfies (string | null)[];
...
export function removeStablecoin(
	options: RemoveStablecoinOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, null] satisfies (string | null)[];
	const parameterNames = ['self', 'Cap'];
...
export function initBalanceManagerMap(
	options: InitBalanceManagerMapOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, null] satisfies (string | null)[];
	const parameterNames = ['self', 'Cap'];
...
export function getBalanceManagerIds(
	options: GetBalanceManagerIdsOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
