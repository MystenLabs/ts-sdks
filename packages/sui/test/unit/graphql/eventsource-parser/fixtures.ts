...
// These fixture helpers replace upstream's eventsource-encoder test dependency.
...
function encode(message: { id?: string; retry?: number; event?: string; data: string }): string {
	return (
...
import { MULTIBYTE_EMOJIS, MULTIBYTE_LINES } from './multibyte.js';
