...
keywords: [transaction plugins, plugin API, Transaction builder, Sui, intents, serialization, middleware, extensibility]
---
...
- `NestedResult`: If a previous command returns a tuple (for example, `SplitCoin`), a `NestedResult` is
