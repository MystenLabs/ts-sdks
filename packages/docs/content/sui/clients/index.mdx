...
keywords: [Sui client, gRPC, GraphQL, JSON-RPC, SuiGrpcClient, SuiGraphQLClient, SuiJsonRpcClient, Core API]
---
...
supported directly on full nodes (for example, querying for transactions or events with various filters).
