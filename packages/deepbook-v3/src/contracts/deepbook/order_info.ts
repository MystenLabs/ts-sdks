...
}> = new MoveStruct({ name: `${$moduleName}::OrderInfo`, fields: {
        pool_id: bcs.Address,
        order_id: bcs.u128(),
...
export const OrderFilled: MoveStruct<{
    ...
    "timestamp": ReturnType<typeof bcs.u64>;
}> = new MoveStruct({ name: `${$moduleName}::OrderFilled`, fields: {
        pool_id: bcs.Address,
...
export const OrderPlaced: MoveStruct<{
    ...
    "expire_timestamp": ReturnType<typeof bcs.u64>;
    "timestamp": ReturnType<typeof bcs.u64>;
}> = new MoveStruct({ name: `${$moduleName}::OrderPlaced`, fields: {
        balance_manager_id: bcs.Address,
        pool_id: bcs.Address,
        order_id: bcs.u128(),
        client_order_id: bcs.u64(),
...
export const OrderExpired: MoveStruct<{
    ...
    "timestamp": ReturnType<typeof bcs.u64>;
}> = new MoveStruct({ name: `${$moduleName}::OrderExpired`, fields: {
        balance_manager_id: bcs.Address,
        pool_id: bcs.Address,
        order_id: bcs.u128(),
        client_order_id: bcs.u64(),
...
export const OrderFullyFilled: MoveStruct<{
    ...
    "is_bid": ReturnType<typeof bcs.bool>;
    "timestamp": ReturnType<typeof bcs.u64>;
}> = new MoveStruct({ name: `${$moduleName}::OrderFullyFilled`, fields: {
        pool_id: bcs.Address,
        order_id: bcs.u128(),
        client_order_id: bcs.u64(),
        balance_manager_id: bcs.Address,
...
export function clientOrderId(options: ClientOrderIdOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export function selfMatchingOption(options: SelfMatchingOptionOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export function originalQuantity(options: OriginalQuantityOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export function orderDeepPrice(options: OrderDeepPriceOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export function expireTimestamp(options: ExpireTimestampOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export function executedQuantity(options: ExecutedQuantityOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export function cumulativeQuoteQuantity(options: CumulativeQuoteQuantityOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export function fillLimitReached(options: FillLimitReachedOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export function orderInserted(options: OrderInsertedOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
