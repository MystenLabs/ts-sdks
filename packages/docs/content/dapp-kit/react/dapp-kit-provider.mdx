...
description: >-
  React context provider that makes dApp Kit available throughout your
  application.
keywords:
  - DAppKitProvider
  - React provider
...
questions:
  ...
  - How does DAppKitProvider work?
answer: >-
  React context provider that makes dApp Kit available throughout your
  application.
goal:
  description: Reader understands and can use DAppKitProvider
  requires:
    - has_frontmatter:
        - title
        - description
