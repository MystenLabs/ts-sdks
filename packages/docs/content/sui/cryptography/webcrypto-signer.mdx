...
keywords: [Web Crypto API, signer, Secp256r1, browser, keypairs, zkLogin, @mysten/signers, session keys]
---

For cases where you need to create keypairs directly within client apps, you can use the Web
