...
title: Key pairs
description: >-
  Create Ed25519, Secp256k1, and Secp256r1 keypairs and derive them from
...
answer: >-
  Create keypairs with Ed25519Keypair.generate(), import from private keys or
  mnemonics, and use them to sign transactions and messages on Sui.
goal:
  description: >-
    Reader can create, import, and use cryptographic keypairs for Sui
    transactions
  requires:
    - has_frontmatter:
        - title
