---
title: Key pairs
description: 'Create and manage Ed25519, Secp256k1, and Secp256r1 keypairs for Sui transaction signing.'
...
For some zklogin accounts, there are two valid addresses for a given set of inputs. This means you might
