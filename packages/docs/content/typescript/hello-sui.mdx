...
In case you encountered the `SyntaxError: Cannot use import statement outside a module` error, easily update the "type" in package.json file to be set on "module":
```javascript
{
  ...
  "type": "module",
