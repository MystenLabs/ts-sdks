 ...
 * @returns {Uint8Array}
 */
export function commit(value, blinding) {
 ...
 * @param {any} dlog_table
 * @returns {number}
 */
export function decrypt(secret_key, ciphertext_bytes, dlog_table) {
    ...
    const ret = wasm.decrypt(ptr0, len0, ptr1, len1, dlog_table);
    if (ret[2]) {
 ...
 * @returns {any}
 */
export function encrypt(public_key, value) {
    const ptr0 = passArray8ToWasm0(public_key, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.encrypt(ptr0, len0, value);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
 ...
 * @returns {Uint8Array}
 */
export function pk_from_sk(sk_bytes) {
    const ptr0 = passArray8ToWasm0(sk_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.pk_from_sk(ptr0, len0);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v2 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
 ...
 * @returns {any}
 */
export function precompute_dlog_table() {
    const ret = wasm.precompute_dlog_table();
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {boolean}
 */
export function verify(proof_bytes, commitment_bytes, range) {
 ...
 * @returns {Uint8Array}
 */
export function prove(value, blinding, range) {
    const ptr0 = passArray8ToWasm0(blinding, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('confidential_transactions_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
