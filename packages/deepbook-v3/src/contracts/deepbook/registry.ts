...
export const DeepbookAdminCap: MoveStruct<{
    "id": typeof bcs.Address;
}> = new MoveStruct({ name: `${$moduleName}::DeepbookAdminCap`, fields: {
        id: bcs.Address
    } });
export const Registry: MoveStruct<{
    "id": typeof bcs.Address;
...
export const RegistryInner: MoveStruct<{
    "allowed_versions": ReturnType<typeof vec_set.VecSet<ReturnType<typeof bcs.u64>>>;
    "pools": typeof bag.Bag;
    "treasury_address": typeof bcs.Address;
}> = new MoveStruct({ name: `${$moduleName}::RegistryInner`, fields: {
        allowed_versions: vec_set.VecSet(bcs.u64()),
        pools: bag.Bag,
        treasury_address: bcs.Address
    } });
export const PoolKey: MoveStruct<{
    "base": typeof type_name.TypeName;
    "quote": typeof type_name.TypeName;
}> = new MoveStruct({ name: `${$moduleName}::PoolKey`, fields: {
        base: type_name.TypeName,
        quote: type_name.TypeName
    } });
export const StableCoinKey: MoveStruct<{
    "dummy_field": ReturnType<typeof bcs.bool>;
}> = new MoveStruct({ name: `${$moduleName}::StableCoinKey`, fields: {
        dummy_field: bcs.bool()
    } });
export const BalanceManagerKey: MoveStruct<{
    "dummy_field": ReturnType<typeof bcs.bool>;
}> = new MoveStruct({ name: `${$moduleName}::BalanceManagerKey`, fields: {
        dummy_field: bcs.bool()
    } });
 ...
 */
export function setTreasuryAddress(options: SetTreasuryAddressOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        'address',
 ...
 */
export function enableVersion(options: EnableVersionOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        'u64',
 ...
 */
export function disableVersion(options: DisableVersionOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        'u64',
...
export function addStablecoin(options: AddStablecoinOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null
...
export function removeStablecoin(options: RemoveStablecoinOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null
...
export interface InitBalanceManagerMapOptions {
    package?: string;
    arguments: InitBalanceManagerMapArguments | [
        self: RawTransactionArgument<string>,
        Cap: RawTransactionArgument<string>
    ];
}
/** Adds the BalanceManagerKey dynamic field to the registry */
export function initBalanceManagerMap(options: InitBalanceManagerMapOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null
...
export interface GetBalanceManagerIdsOptions {
    package?: string;
    arguments: GetBalanceManagerIdsArguments | [
        self: RawTransactionArgument<string>,
        owner: RawTransactionArgument<string>
    ];
}
/** Get the balance manager IDs for a given owner */
export function getBalanceManagerIds(options: GetBalanceManagerIdsOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        'address'
...
export function isStablecoin(options: IsStablecoinOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null,
        null
