...
const _EpochStateFields = {
	EpochChangeSync: bcs.u16(),
	EpochChangeDone: bcs.u64(),
	NextParamsSelected: bcs.u64(),
};
/** The epoch state. */
export const EpochState: MoveEnum<typeof _EpochStateFields> = new MoveEnum({
	name: `${$moduleName}::EpochState`,
	fields: _EpochStateFields,
});
const _StakingInnerV1Fields = {
...
export const StakingInnerV1: MoveStruct<typeof _StakingInnerV1Fields> = new MoveStruct({
	name: `${$moduleName}::StakingInnerV1`,
	fields: _StakingInnerV1Fields,
});
