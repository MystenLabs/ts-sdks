...
const $moduleName = '@suins/auction::uq32_32';
...
export interface FromIntOptions {
	package?: string;
	arguments: FromIntArguments | [integer: RawTransactionArgument<number>];
}
/**
...
export function intMul(options: IntMulOptions) {
	const packageAddress = options.package ?? '@suins/auction';
	const argumentsTypes = ['u64', null] satisfies (string | null)[];
