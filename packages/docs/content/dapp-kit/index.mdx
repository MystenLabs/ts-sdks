...
answer: >-
  Sui dApp Kit provides wallet connection, transaction signing, and network
  management for Sui dApps, with a framework-agnostic core
  (@mysten/dapp-kit-core) and React bindings (@mysten/dapp-kit-react).
goal:
  description: >-
    Reader understands what Sui dApp Kit provides and can choose between React
    bindings and the framework-agnostic core
  requires:
    - has_frontmatter:
        - title
        - description
