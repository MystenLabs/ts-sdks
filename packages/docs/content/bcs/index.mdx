...
answer: >-
  The BCS library (@mysten/bcs) provides Binary Canonical Serialization for
  encoding and decoding Sui Move types in TypeScript, supporting structs, enums,
  vectors, and all Move primitive types.
goal:
