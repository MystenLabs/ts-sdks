...
title: Payment Kit
description: >-
  Accept payments in any coin type on the Sui blockchain with built-in duplicate
  prevention.
keywords:
  - Payment Kit
  - Sui payments
...
answer: >-
  Payment Kit accepts payments in any coin type on Sui with built-in duplicate
  prevention, receipt tracking, and a registry for managing payment
  destinations.
goal:
