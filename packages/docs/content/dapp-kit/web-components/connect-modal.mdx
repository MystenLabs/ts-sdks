...
title: Connect Modal
description: >-
  Framework-agnostic web component for wallet selection and connection in Sui
  dApps.
keywords:
  - connect modal
  - web component
...
goal:
  description: >-
    Reader understands framework-agnostic web component for wallet selection and
    connection in Sui dApps
  requires:
    - has_frontmatter:
        - title
        - description
