...
export const Config: MoveStruct<{
    "public_key": ReturnType<typeof bcs.vector<ReturnType<typeof bcs.u8>>>;
    "three_char_price": ReturnType<typeof bcs.u64>;
    "four_char_price": ReturnType<typeof bcs.u64>;
    "five_plus_char_price": ReturnType<typeof bcs.u64>;
}> = new MoveStruct({ name: `${$moduleName}::Config`, fields: {
...
export interface SetPublicKeyOptions {
    ...
    arguments: [
        ...
        _: RawTransactionArgument<Array<number>>
    ];
}
export function setPublicKey(options: SetPublicKeyOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    const argumentsTypes = [
        null,
        'vector<u8>'
...
export interface SetThreeCharPriceOptions {
    ...
    arguments: [
        _: TransactionArgument,
        _: RawTransactionArgument<number | bigint>
    ];
}
export function setThreeCharPrice(options: SetThreeCharPriceOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    const argumentsTypes = [
        null,
        'u64'
...
export function setFourCharPrice(options: SetFourCharPriceOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    const argumentsTypes = [
        null,
        'u64'
...
export function setFivePlusCharPrice(options: SetFivePlusCharPriceOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    const argumentsTypes = [
        null,
        'u64'
...
export function publicKey(options: PublicKeyOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export interface ThreeCharPriceOptions {
    package?: string;
    arguments: ThreeCharPriceArguments | [
        _: TransactionArgument
    ];
}
export function threeCharPrice(options: ThreeCharPriceOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export interface FourCharPriceOptions {
    package?: string;
    arguments: FourCharPriceArguments | [
        _: TransactionArgument
    ];
}
export function fourCharPrice(options: FourCharPriceOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export interface FivePlusCharPriceOptions {
    package?: string;
    arguments: FivePlusCharPriceArguments | [
        _: TransactionArgument
    ];
}
export function fivePlusCharPrice(options: FivePlusCharPriceOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export interface AssertValidUserRegisterableDomainOptions {
    package?: string;
    arguments: AssertValidUserRegisterableDomainArguments | [
        _: TransactionArgument
    ];
}
export function assertValidUserRegisterableDomain(options: AssertValidUserRegisterableDomainOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
