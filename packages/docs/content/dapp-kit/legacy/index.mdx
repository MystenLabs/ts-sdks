...
description: >-
  Legacy dApp Kit API reference for the deprecated @mysten/dapp-kit package
  using JSON RPC.
keywords:
  - legacy
  - dApp Kit
  ...
  - deprecated
questions:
  - What is Sui dApp Kit (Legacy)?
  - How do I get started with Sui dApp Kit (Legacy)?
  - How does Setting up providers work?
  - How does Using UI components to connect to a wallet work?
answer: >-
  Legacy dApp Kit API reference for the deprecated @mysten/dapp-kit package
  using JSON RPC.
goal:
  description: >-
    Reader understands what Sui dApp Kit (Legacy) provides and how to get
    started
  requires:
    - has_frontmatter:
        - title
