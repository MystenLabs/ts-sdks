...
[React wrapper](../framework-guides/react/components/connect-button) for the button.
...
are detected in the browser. For Next.js guide see [here](../framework-guides/next-js).
