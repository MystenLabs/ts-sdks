...
keywords: [codegen, code generation, TypeScript, Sui Move, type-safe, smart contracts, @mysten/codegen, BCS]
---
...
Only generate a single type from a dependency (functions are omitted automatically because `generate`
