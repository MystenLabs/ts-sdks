...
const _SystemStateInnerV1Fields = {
...
export const SystemStateInnerV1: MoveStruct<typeof _SystemStateInnerV1Fields> = new MoveStruct({
	name: `${$moduleName}::SystemStateInnerV1`,
	fields: _SystemStateInnerV1Fields,
});
