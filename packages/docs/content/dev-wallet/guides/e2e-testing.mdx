...
Automated tests can't click "Approve" in a headless browser. Set `autoApprove: true` and the
wallet signs everything immediately — same wallet-standard APIs, no approval modal.
