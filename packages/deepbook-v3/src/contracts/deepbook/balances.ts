...
export const Balances: MoveStruct<{
    "base": ReturnType<typeof bcs.u64>;
    "quote": ReturnType<typeof bcs.u64>;
    "deep": ReturnType<typeof bcs.u64>;
}> = new MoveStruct({ name: `${$moduleName}::Balances`, fields: {
        base: bcs.u64(),
        quote: bcs.u64(),
        deep: bcs.u64()
    } });