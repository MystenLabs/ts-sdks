...
The new version uses direct promise-based calls instead of React Query mutations. This decoupling from
TanStack Query gives you flexibility to use any state management or data fetching solution you prefer.
