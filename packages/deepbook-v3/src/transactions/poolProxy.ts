...
export class PoolProxyContract {
	 ...
	 */
	modifyOrder =
		(marginManagerKey: string, orderId: string, newQuantity: number) =>
		(tx: Transaction): void => {
	 ...
	 */
	cancelOrder =
		(marginManagerKey: string, orderId: string) =>
		(tx: Transaction): void => {
			const marginManager = this.#config.getMarginManager(marginManagerKey);
			const pool = this.#config.getPool(marginManager.poolKey);
			const baseCoin = this.#config.getCoin(pool.baseCoin);
	 ...
	 */
	cancelOrders =
		(marginManagerKey: string, orderIds: string[]) =>
		(tx: Transaction): void => {
			const marginManager = this.#config.getMarginManager(marginManagerKey);
			const pool = this.#config.getPool(marginManager.poolKey);
			const baseCoin = this.#config.getCoin(pool.baseCoin);
	 ...
	 */
	stake =
		(marginManagerKey: string, stakeAmount: number) =>
		(tx: Transaction): void => {
			const marginManager = this.#config.getMarginManager(marginManagerKey);
			const pool = this.#config.getPool(marginManager.poolKey);
			const baseCoin = this.#config.getCoin(pool.baseCoin);
	 ...
	 */
	submitProposal =
		(marginManagerKey: string, params: MarginProposalParams) =>
		(tx: Transaction): void => {
	 ...
	 */
	vote =
		(marginManagerKey: string, proposalId: string) =>
		(tx: Transaction): void => {
			const marginManager = this.#config.getMarginManager(marginManagerKey);
			const pool = this.#config.getPool(marginManager.poolKey);
			const baseCoin = this.#config.getCoin(pool.baseCoin);
