...
keywords: [PaymentRegistry, registry management, coin types, expiration, onchain, Sui, Payment Kit]
---
...
2. **Use descriptive names**: Choose registry names that clearly identify their purpose (for example,
