...
export const CouponsApp: MoveStruct<{
    "dummy_field": ReturnType<typeof bcs.bool>;
}> = new MoveStruct({ name: `${$moduleName}::CouponsApp`, fields: {
        dummy_field: bcs.bool()
    } });
export const AppKey: MoveStruct<{
    "dummy_field": ReturnType<typeof bcs.bool>;
}> = new MoveStruct({ name: `${$moduleName}::AppKey<phantom A>`, fields: {
        dummy_field: bcs.bool()
    } });
export const CouponHouse: MoveStruct<{
    "data": typeof data.Data;
    "version": ReturnType<typeof bcs.u8>;
    "storage": typeof bcs.Address;
}> = new MoveStruct({ name: `${$moduleName}::CouponHouse`, fields: {
        data: data.Data,
        version: bcs.u8(),
        storage: bcs.Address
    } });
...
export interface ApplyCouponOptions {
    package?: string;
    arguments: ApplyCouponArguments | [
        suins: RawTransactionArgument<string>,
        intent: TransactionArgument,
        couponCode: RawTransactionArgument<string>
    ];
}
export function applyCoupon(options: ApplyCouponOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/coupons';
    const argumentsTypes = [
        null,
        null,
...
export interface RegisterWithCouponOptions {
    package?: string;
    arguments: RegisterWithCouponArguments | [
        Suins: RawTransactionArgument<string>,
        CouponCode: RawTransactionArgument<string>,
        DomainName: RawTransactionArgument<string>,
        NoYears: RawTransactionArgument<number>,
...
export function registerWithCoupon(options: RegisterWithCouponOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/coupons';
    const argumentsTypes = [
        null,
        '0x1::string::String',
...
export interface CalculateSalePriceOptions {
    package?: string;
    arguments: CalculateSalePriceArguments | [
        Suins: RawTransactionArgument<string>,
        Price: RawTransactionArgument<number | bigint>,
        CouponCode: RawTransactionArgument<string>
    ];
}
export function calculateSalePrice(options: CalculateSalePriceOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/coupons';
    const argumentsTypes = [
        null,
        'u64',
...
export interface AppDataMutOptions<A extends BcsType<any>> {
    package?: string;
    arguments: AppDataMutArguments<A> | [
        suins: RawTransactionArgument<string>,
        _: RawTransactionArgument<A>
    ];
    typeArguments: [
...
export function appDataMut<A extends BcsType<any>>(options: AppDataMutOptions<A>): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/coupons';
    const argumentsTypes = [
        null,
...
export interface AssertVersionIsValidOptions {
    package?: string;
    arguments: AssertVersionIsValidArguments | [
        self: TransactionArgument
    ];
}
/** Validate that the version of the app is the latest. */
export function assertVersionIsValid(options: AssertVersionIsValidOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/coupons';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export interface AdminAddCouponOptions {
    package?: string;
    arguments: AdminAddCouponArguments | [
        _: RawTransactionArgument<string>,
        suins: RawTransactionArgument<string>,
        code: RawTransactionArgument<string>,
        kind: RawTransactionArgument<number>,
 ...
 */
export function adminAddCoupon(options: AdminAddCouponOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/coupons';
    const argumentsTypes = [
        null,
        null,
...
export interface AdminRemoveCouponOptions {
    package?: string;
    arguments: AdminRemoveCouponArguments | [
        _: RawTransactionArgument<string>,
        suins: RawTransactionArgument<string>,
        code: RawTransactionArgument<string>
    ];
}
export function adminRemoveCoupon(options: AdminRemoveCouponOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/coupons';
    const argumentsTypes = [
        null,
        null,
...
export interface AppAddCouponOptions {
    package?: string;
    arguments: AppAddCouponArguments | [
        data: TransactionArgument,
        code: RawTransactionArgument<string>,
        kind: RawTransactionArgument<number>,
        amount: RawTransactionArgument<number | bigint>,
...
export function appAddCoupon(options: AppAddCouponOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/coupons';
    const argumentsTypes = [
        null,
        '0x1::string::String',
...
export interface AppRemoveCouponOptions {
    package?: string;
    arguments: AppRemoveCouponArguments | [
        data: TransactionArgument,
        code: RawTransactionArgument<string>
    ];
}
export function appRemoveCoupon(options: AppRemoveCouponOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/coupons';
    const argumentsTypes = [
        null,
        '0x1::string::String'
