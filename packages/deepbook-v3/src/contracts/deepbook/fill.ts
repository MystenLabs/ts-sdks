...
export const Fill: MoveStruct<{
    "maker_order_id": ReturnType<typeof bcs.u128>;
    "maker_client_order_id": ReturnType<typeof bcs.u64>;
    "execution_price": ReturnType<typeof bcs.u64>;
    "balance_manager_id": typeof bcs.Address;
    "expired": ReturnType<typeof bcs.bool>;
    "completed": ReturnType<typeof bcs.bool>;
    "original_maker_quantity": ReturnType<typeof bcs.u64>;
    "base_quantity": ReturnType<typeof bcs.u64>;
    "quote_quantity": ReturnType<typeof bcs.u64>;
    "taker_is_bid": ReturnType<typeof bcs.bool>;
    "maker_epoch": ReturnType<typeof bcs.u64>;
    "maker_deep_price": typeof deep_price.OrderDeepPrice;
...
}> = new MoveStruct({ name: `${$moduleName}::Fill`, fields: {
...
export function makerOrderId(options: MakerOrderIdOptions): (tx: Transaction) => TransactionResult {
...
export function makerClientOrderId(options: MakerClientOrderIdOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export function executionPrice(options: ExecutionPriceOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export function balanceManagerId(options: BalanceManagerIdOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export function completed(options: CompletedOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export function originalMakerQuantity(options: OriginalMakerQuantityOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export function baseQuantity(options: BaseQuantityOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export function takerIsBid(options: TakerIsBidOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export function quoteQuantity(options: QuoteQuantityOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export function makerEpoch(options: MakerEpochOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export function makerDeepPrice(options: MakerDeepPriceOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export function takerFee(options: TakerFeeOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export function takerFeeIsDeep(options: TakerFeeIsDeepOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export function makerFee(options: MakerFeeOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
...
export function makerFeeIsDeep(options: MakerFeeIsDeepOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@deepbook/core';
    const argumentsTypes = [
        null
    ] satisfies (string | null)[];
