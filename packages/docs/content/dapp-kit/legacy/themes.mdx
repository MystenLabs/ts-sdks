---
title: Themes
description: Theming API for customizing the appearance of legacy dApp Kit components.
keywords:
  - themes
  - theming
  - lightTheme
...
questions:
  - What is Themes?
  - How do I use Themes?
  - How does Dynamic themes work?
  - How does Theme variables work?
answer: Theming API for customizing the appearance of legacy dApp Kit components.
goal:
  description: >-
    Reader understands theming API for customizing the appearance of legacy dApp Kit components
  requires:
    - has_frontmatter:
        - title
        - description
