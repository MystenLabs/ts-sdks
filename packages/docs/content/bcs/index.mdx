...
keywords:
  ...
  - '@mysten/bcs'
questions:
  - What is BCS - Binary Canonical Serialization?
  - How do I get started with BCS - Binary Canonical Serialization?
  - How do I install BCS - Binary Canonical Serialization?
answer: Encode and decode Sui Move types with Binary Canonical Serialization.
goal:
  description: >-
    Reader understands what BCS - Binary Canonical Serialization is, how to
    install it, and its core capabilities
  requires:
    - has_frontmatter:
        - title
        - description
