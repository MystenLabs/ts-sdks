...
answer: >-
  zkLogin lets users authenticate with OAuth providers (Google, Facebook, etc.)
  and derive Sui addresses from their social accounts using zero-knowledge
  proofs, eliminating the need for private key management.
goal:
