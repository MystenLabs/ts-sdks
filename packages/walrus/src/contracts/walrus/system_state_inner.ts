...
export const SystemStateInnerV1: MoveStruct<{
	committee: typeof bls_aggregate.BlsCommittee;
	total_capacity_size: ReturnType<typeof bcs.u64>;
	used_capacity_size: ReturnType<typeof bcs.u64>;
	storage_price_per_unit_size: ReturnType<typeof bcs.u64>;
	write_price_per_unit_size: ReturnType<typeof bcs.u64>;
	future_accounting: typeof storage_accounting.FutureAccountingRingBuffer;
	event_blob_certification_state: typeof event_blob.EventBlobCertificationState;
	deny_list_sizes: typeof extended_field.ExtendedField;
}> = new MoveStruct({
