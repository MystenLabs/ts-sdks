...
<Callout>
	For **React**, you might prefer to install React bindings [install React
...
Start with [creating a dApp Kit instance](./create-dapp-kit). You might also want to check our
