...
questions:
  - What is Seal SDK?
  - How do I get started with Seal SDK?
  - How do I install Seal SDK?
answer: Decentralized secrets management with threshold encryption on Sui.
goal:
  description: >-
    Reader understands what Seal SDK is, how to install it, and its core
    capabilities
  requires:
    - has_frontmatter:
        - title
