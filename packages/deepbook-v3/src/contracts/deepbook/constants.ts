...
export function poolCreationFee(
	options: PoolCreationFeeOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	return (tx: Transaction) =>
		tx.moveCall({
...
export function floatScaling(
	options: FloatScalingOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	return (tx: Transaction) =>
		tx.moveCall({
...
export function floatScalingU128(
	options: FloatScalingU128Options = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	return (tx: Transaction) =>
		tx.moveCall({
...
export function immediateOrCancel(
	options: ImmediateOrCancelOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	return (tx: Transaction) =>
		tx.moveCall({
...
export function fillOrKill(
	options: FillOrKillOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	return (tx: Transaction) =>
		tx.moveCall({
...
export function maxRestriction(
	options: MaxRestrictionOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	return (tx: Transaction) =>
		tx.moveCall({
...
export function partiallyFilled(
	options: PartiallyFilledOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	return (tx: Transaction) =>
		tx.moveCall({
...
export function selfMatchingAllowed(
	options: SelfMatchingAllowedOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	return (tx: Transaction) =>
		tx.moveCall({
...
export function cancelTaker(
	options: CancelTakerOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	return (tx: Transaction) =>
		tx.moveCall({
...
export function cancelMaker(
	options: CancelMakerOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	return (tx: Transaction) =>
		tx.moveCall({
...
export function phaseOutEpochs(
	options: PhaseOutEpochsOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	return (tx: Transaction) =>
		tx.moveCall({
...
export function defaultStakeRequired(
	options: DefaultStakeRequiredOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	return (tx: Transaction) =>
		tx.moveCall({
...
export function maxOpenOrders(
	options: MaxOpenOrdersOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	return (tx: Transaction) =>
		tx.moveCall({
...
export function maxSliceSize(
	options: MaxSliceSizeOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	return (tx: Transaction) =>
		tx.moveCall({
...
export function feePenaltyMultiplier(
	options: FeePenaltyMultiplierOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	return (tx: Transaction) =>
		tx.moveCall({
...
export function defaultEwmaAlpha(
	options: DefaultEwmaAlphaOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	return (tx: Transaction) =>
		tx.moveCall({
...
export function defaultZScoreThreshold(
	options: DefaultZScoreThresholdOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	return (tx: Transaction) =>
		tx.moveCall({
...
export function defaultAdditionalTakerFee(
	options: DefaultAdditionalTakerFeeOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	return (tx: Transaction) =>
		tx.moveCall({
...
export function maxEwmaAlpha(
	options: MaxEwmaAlphaOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	return (tx: Transaction) =>
		tx.moveCall({
...
export function maxZScoreThreshold(
	options: MaxZScoreThresholdOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	return (tx: Transaction) =>
		tx.moveCall({
...
export function maxAdditionalTakerFee(
	options: MaxAdditionalTakerFeeOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	return (tx: Transaction) =>
		tx.moveCall({
...
export function referralMaxMultiplier(
	options: ReferralMaxMultiplierOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	return (tx: Transaction) =>
		tx.moveCall({
...
export function referralMultiplier(
	options: ReferralMultiplierOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	return (tx: Transaction) =>
		tx.moveCall({
...
export function maxBalanceManagers(
	options: MaxBalanceManagersOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	return (tx: Transaction) =>
		tx.moveCall({
...
export function referralDfKey(
	options: ReferralDfKeyOptions = {},
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	return (tx: Transaction) =>
		tx.moveCall({
