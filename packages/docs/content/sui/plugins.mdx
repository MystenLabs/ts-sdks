...
keywords:
  ...
  - extensibility
questions:
  - What is Transaction Plugins?
  - How do I use Transaction Plugins?
  - How does Transaction Plugins work?
answer: Extend transaction building with reusable plugins.
goal:
  description: Reader understands and can use Transaction Plugins
  requires:
    - has_frontmatter:
        - title
        - description
