...
keywords:
  ...
  - transport-agnostic
questions:
  - What is Building SDKs?
  - How do I use Building SDKs?
  - How does Building SDKs work?
answer: Build custom SDKs on top of the Sui TypeScript SDK
goal:
  description: Reader understands and can use Building SDKs
  requires:
    - has_frontmatter:
        - title
        - description
