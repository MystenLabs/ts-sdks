...
description: React provider for managing the active SuiJsonRpcClient in legacy dApp Kit.
keywords:
  - SuiClientProvider
  - React provider
  - Sui client
  ...
  - dApp Kit
questions:
  - What is SuiClientProvider?
  - How do I use SuiClientProvider?
  - How does Props work?
  - How does Controlled component work?
answer: React provider for managing the active SuiJsonRpcClient in legacy dApp Kit.
goal:
  description: >-
    Reader can use the React provider for managing the active SuiJsonRpcClient in legacy dApp Kit
  requires:
    - has_frontmatter:
        - title
        - description
