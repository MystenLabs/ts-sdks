...
keywords:
  ...
  - breaking changes
questions:
  - How do I migrate @mysten/dapp-kit?
  - What changed in @mysten/dapp-kit?
  - What are the breaking changes in @mysten/dapp-kit?
answer: Migrate @mysten/dapp-kit to the new dapp-kit-react package in 2.0
goal:
  description: Reader can migrate their code to @mysten/dapp-kit
  requires:
    - has_frontmatter:
        - title
        - description
