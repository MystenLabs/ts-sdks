...
description: Switch the active account in the connected wallet using the dApp Kit switchAccount action.
keywords: [switch account, dApp Kit, wallet account, multi-account, Sui, action, TypeScript]
---
...
<Callout type="info">
	...
	application. Changing the active account in the app does not affect the wallet itself, and
