...
title: Examples
description: >-
  Practical code examples for kiosk transactions including minting, listing, and
  purchasing.
keywords:
  - kiosk examples
  - minting
...
goal:
  description: >-
    Reader understands practical code examples for kiosk transactions including
    minting, listing, and purchasing
  requires:
    - has_frontmatter:
        - title
        - description
