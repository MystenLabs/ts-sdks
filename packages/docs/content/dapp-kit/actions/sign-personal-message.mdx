...
description: >-
  Sign an arbitrary message with the connected wallet for authentication or
  proof of ownership.
keywords:
  - sign message
  - personal message
...
questions:
  - How do I sign personal message in Sui dApp Kit?
  - What is the Sign Personal Message action?
  - How do I use Sign Personal Message?
answer: >-
  Sign an arbitrary message with the connected wallet for authentication or
  proof of ownership.
goal:
  description: Reader can use Sign Personal Message in their application
  requires:
    - has_frontmatter:
        - title
        - description
