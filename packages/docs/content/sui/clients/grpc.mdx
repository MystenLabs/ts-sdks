...
- [Querying data](/sui/clients/querying) and [Executing transactions](/sui/clients/executing) for
  the methods every client shares
- [Core API](/sui/clients/core) for writing libraries against any client
