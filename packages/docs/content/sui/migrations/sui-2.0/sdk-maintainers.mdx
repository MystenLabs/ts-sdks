...
keywords:
  ...
  - breaking changes
questions:
  - How do I migrate SDK Maintainers?
  - What changed in SDK Maintainers?
  - What are the breaking changes in SDK Maintainers?
answer: Migration guide for SDK maintainers and library authors upgrading to 2.0
goal:
  description: Reader can migrate their code to SDK Maintainers
  requires:
    - has_frontmatter:
        - title
        - description
