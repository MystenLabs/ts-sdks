...
description: Legacy React hook to get the currently connected wallet and connection status.
keywords:
  - useCurrentWallet
  - React hook
  - current wallet
...
questions:
  ...
  - How does Connection status properties work?
answer: Legacy React hook to get the currently connected wallet and connection status.
goal:
  description: >-
    Reader can use the legacy React hook to get the currently connected wallet and connection status
  requires:
    - has_frontmatter:
        - title
        - description
