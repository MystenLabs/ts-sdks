...
description: >-
  Switch the active account in the connected wallet using the dApp Kit
...
keywords:
  ...
  - TypeScript
questions:
  - How do I switch account in Sui dApp Kit?
  - What is the Switch Account action?
  - How do I use Switch Account?
answer: >-
  Switch the active account in the connected wallet using the dApp Kit
  switchAccount action.
goal:
  description: Reader can use Switch Account in their application
  requires:
    - has_frontmatter:
        - title
        - description
