...
keywords:
  ...
  - '@mysten packages'
questions:
  - How do I migrate Migrate to 2.0?
  - What changed in Migrate to 2.0?
  - What are the breaking changes in Migrate to 2.0?
answer: Migration guide for Sui TypeScript SDK 2.0 covering all @mysten packages
goal:
  description: >-
    Reader understands what Migrate to 2.0 is, how to install it, and its core
    capabilities
  requires:
    - has_frontmatter:
        - title
