 ...
 * @returns {number}
 */
exports.decrypt = function(secret_key, ciphertext_bytes, dlog_table) {
 ...
 * @returns {Uint8Array}
 */
exports.generate_private_key = function() {
 ...
 * @returns {any}
 */
exports.encrypt = function(public_key, value) {
 ...
 * @returns {Uint8Array}
 */
exports.pk_from_sk = function(sk_bytes) {
 ...
 * @returns {any}
 */
exports.precompute_dlog_table = function() {
