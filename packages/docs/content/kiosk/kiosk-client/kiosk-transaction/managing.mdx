...
description: >-
  Manage kiosk items by placing, listing, delisting, and withdrawing using the
  Kiosk SDK.
keywords:
  - kiosk management
  - place
...
goal:
  description: >-
    Reader understands manage kiosk items by placing, listing, delisting, and
    withdrawing using the Kiosk SDK
  requires:
    - has_frontmatter:
        - title
        - description
