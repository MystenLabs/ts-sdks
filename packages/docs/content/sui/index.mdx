...
keywords:
  ...
  - network
questions:
  - What is Sui TypeScript SDK?
  - How do I use Sui TypeScript SDK?
  - How does Sui TypeScript SDK work?
answer: TypeScript SDK for building on the Sui blockchain
goal:
  description: >-
    Reader understands what Sui TypeScript SDK is, how to install it, and its
    core capabilities
  requires:
    - has_frontmatter:
        - title
