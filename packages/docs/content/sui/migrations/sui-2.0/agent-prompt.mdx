...
keywords:
  ...
  - codebase upgrade
questions:
  - How do I migrate Agent Migration Prompt?
  - What changed in Agent Migration Prompt?
  - What are the breaking changes in Agent Migration Prompt?
answer: AI agent prompt for automated SDK 2.0 migration of your codebase.
goal:
  description: Reader can migrate their code to Agent Migration Prompt
  requires:
    - has_frontmatter:
        - title
        - description
