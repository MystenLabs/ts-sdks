...
keywords:
  ...
  - breaking changes
questions:
  - How do I migrate Wallet Builders?
  - What changed in Wallet Builders?
  - What are the breaking changes in Wallet Builders?
answer: Migration guide for wallet extension developers upgrading to 2.0.
goal:
  description: Reader can migrate their code to Wallet Builders
  requires:
    - has_frontmatter:
        - title
        - description
