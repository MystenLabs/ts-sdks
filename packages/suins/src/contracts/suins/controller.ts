...
export const SubnamePrunedEvent: MoveStruct<{
    "subdomain": typeof domain.Domain;
    "parent_domain": typeof domain.Domain;
}> = new MoveStruct({ name: `${$moduleName}::SubnamePrunedEvent`, fields: {
        subdomain: domain.Domain,
        parent_domain: domain.Domain
    } });
export const ControllerV2: MoveTuple<[
    ReturnType<typeof bcs.bool>
]> = new MoveTuple({ name: `${$moduleName}::ControllerV2`, fields: [bcs.bool()] });
export const Controller: MoveStruct<{
    "dummy_field": ReturnType<typeof bcs.bool>;
}> = new MoveStruct({ name: `${$moduleName}::Controller`, fields: {
...
export interface SetObjectReverseLookupOptions {
    package?: string;
    arguments: SetObjectReverseLookupArguments | [
        suins: RawTransactionArgument<string>,
        obj: RawTransactionArgument<string>,
        domainName: RawTransactionArgument<string>
    ];
 ...
 */
export function setObjectReverseLookup(options: SetObjectReverseLookupOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    const argumentsTypes = [
        null,
        '0x2::object::ID',
...
export interface UnsetObjectReverseLookupOptions {
    package?: string;
    arguments: UnsetObjectReverseLookupArguments | [
        suins: RawTransactionArgument<string>,
        obj: RawTransactionArgument<string>
    ];
}
 ...
 * reference of the object.
 */
export function unsetObjectReverseLookup(options: UnsetObjectReverseLookupOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    const argumentsTypes = [
        null,
        '0x2::object::ID'
...
export interface SetUserDataOptions {
    package?: string;
    arguments: SetUserDataArguments | [
        suins: RawTransactionArgument<string>,
        nft: RawTransactionArgument<string>,
        key: RawTransactionArgument<string>,
        value: RawTransactionArgument<string>
...
export function setUserData(options: SetUserDataOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    const argumentsTypes = [
        null,
        null,
...
export interface UnsetUserDataOptions {
    package?: string;
    arguments: UnsetUserDataArguments | [
        suins: RawTransactionArgument<string>,
        nft: RawTransactionArgument<string>,
        key: RawTransactionArgument<string>
    ];
...
export function unsetUserData(options: UnsetUserDataOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    const argumentsTypes = [
        null,
        null,
...
export interface BurnExpiredOptions {
    package?: string;
    arguments: BurnExpiredArguments | [
        suins: RawTransactionArgument<string>,
        nft: RawTransactionArgument<string>
    ];
}
export function burnExpired(options: BurnExpiredOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    const argumentsTypes = [
        null,
        null,
...
export interface BurnExpiredSubnameOptions {
    package?: string;
    arguments: BurnExpiredSubnameArguments | [
        suins: RawTransactionArgument<string>,
        nft: RawTransactionArgument<string>
    ];
}
export function burnExpiredSubname(options: BurnExpiredSubnameOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    const argumentsTypes = [
        null,
        null,
...
export interface PruneExpiredSubnameOptions {
    package?: string;
    arguments: PruneExpiredSubnameArguments | [
        suins: RawTransactionArgument<string>,
        parent: RawTransactionArgument<string>,
        subdomainName: RawTransactionArgument<string>
    ];
 ...
 * subdomain NFT.
 */
export function pruneExpiredSubname(options: PruneExpiredSubnameOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    const argumentsTypes = [
        null,
        null,
...
export interface PruneExpiredSubnamesOptions {
    package?: string;
    arguments: PruneExpiredSubnamesArguments | [
        suins: RawTransactionArgument<string>,
        parent: RawTransactionArgument<string>,
        subdomainNames: RawTransactionArgument<Array<string>>
    ];
 ...
 */
export function pruneExpiredSubnames(options: PruneExpiredSubnamesOptions): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    const argumentsTypes = [
        null,
        null,
