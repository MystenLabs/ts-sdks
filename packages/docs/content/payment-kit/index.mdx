---
title: Payment Kit
description: Accept payments in any coin type on the Sui blockchain with built-in duplicate prevention.
keywords: [Payment Kit, Sui payments, payment processing, registry, receipts, TypeScript, blockchain payments]
---
...
The Sui Payment Kit SDK is a TypeScript library that provides a straightforward and secure way to process
