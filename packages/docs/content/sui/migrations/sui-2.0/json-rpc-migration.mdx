...
keywords:
  ...
  - transport
questions:
  - How do I migrate Migrating from JSON-RPC?
  - What changed in Migrating from JSON-RPC?
  - What are the breaking changes in Migrating from JSON-RPC?
answer: Migrate deprecated JSON-RPC code to shared gRPC and GraphQL top-level methods
goal:
  description: Reader can migrate their code to Migrating from JSON-RPC
  requires:
    - has_frontmatter:
        - title
        - description
