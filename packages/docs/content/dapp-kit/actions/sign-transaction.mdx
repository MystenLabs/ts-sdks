...
description: >-
  Sign a Sui transaction without executing it for deferred or multi-signature
  scenarios.
keywords:
  - sign transaction
  - dApp Kit
  ...
  - TypeScript
questions:
  - How do I sign transaction in Sui dApp Kit?
  - What is the Sign Transaction action?
  - How do I use Sign Transaction?
answer: >-
  Sign a Sui transaction without executing it for deferred or multi-signature
  scenarios.
goal:
  description: Reader can use Sign Transaction in their application
  requires:
    - has_frontmatter:
        - title
        - description
