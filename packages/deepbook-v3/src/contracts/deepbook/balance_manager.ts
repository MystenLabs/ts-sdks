...
export const ReferralKey: MoveTuple<[typeof bcs.Address]> = new MoveTuple({
...
export function newWithCustomOwner(
	options: NewWithCustomOwnerOptions,
...
export function newWithCustomOwnerAndCaps(
	options: NewWithCustomOwnerAndCapsOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = ['address'] satisfies (string | null)[];
	const parameterNames = ['Owner'];
...
export function newWithCustomOwnerCaps(
	options: NewWithCustomOwnerCapsOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
...
export function setBalanceManagerReferral(
	options: SetBalanceManagerReferralOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, null, null] satisfies (string | null)[];
	const parameterNames = ['balanceManager', 'referral', 'tradeCap'];
...
export function unsetReferral(
	options: UnsetReferralOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
...
export function unsetBalanceManagerReferral(
	options: UnsetBalanceManagerReferralOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
...
export function mintDepositCap(
	options: MintDepositCapOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null] satisfies (string | null)[];
	const parameterNames = ['balanceManager'];
...
export function mintWithdrawCap(
	options: MintWithdrawCapOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null] satisfies (string | null)[];
	const parameterNames = ['balanceManager'];
 ...
 */
export function revokeTradeCap(
	options: RevokeTradeCapOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
...
export function generateProofAsOwner(
	options: GenerateProofAsOwnerOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null] satisfies (string | null)[];
	const parameterNames = ['balanceManager'];
...
export function generateProofAsTrader(
	options: GenerateProofAsTraderOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, null] satisfies (string | null)[];
	const parameterNames = ['balanceManager', 'tradeCap'];
...
export function depositWithCap(
	options: DepositWithCapOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, null, null] satisfies (string | null)[];
...
export function withdrawWithCap(
	options: WithdrawWithCapOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
...
export function registerManager(
	options: RegisterManagerOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, null] satisfies (string | null)[];
...
export function registerBalanceManager(
	options: RegisterBalanceManagerOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, null] satisfies (string | null)[];
	const parameterNames = ['balanceManager', 'registry'];
...
export function getBalanceManagerReferralId(
	options: GetBalanceManagerReferralIdOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null, '0x2::object::ID'] satisfies (string | null)[];
...
export function referralOwner(
	options: ReferralOwnerOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null] satisfies (string | null)[];
...
export function balanceManagerReferralOwner(
	options: BalanceManagerReferralOwnerOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null] satisfies (string | null)[];
	const parameterNames = ['referral'];
...
export function balanceManagerReferralPoolId(
	options: BalanceManagerReferralPoolIdOptions,
): (tx: Transaction) => TransactionResult {
	const packageAddress = options.package ?? '@deepbook/core';
	const argumentsTypes = [null] satisfies (string | null)[];
	const parameterNames = ['referral'];
