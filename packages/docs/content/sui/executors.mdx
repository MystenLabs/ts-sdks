...
answer: >-
  Executors manage transaction submission with automatic retry, gas management,
  and parallel execution support for high-throughput Sui applications.
goal:
  description: >-
    Reader can use executors to manage transaction submission with retry and
    parallel execution
  requires:
    - has_frontmatter:
        - title
