...
export function suiTld(options: SuiTldOptions = {}): (tx: Transaction) => TransactionResult {
...
export function defaultImage(options: DefaultImageOptions = {}): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'constants',
...
export function mistPerSui(options: MistPerSuiOptions = {}): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'constants',
...
export function minDomainLength(options: MinDomainLengthOptions = {}): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'constants',
...
export function maxDomainLength(options: MaxDomainLengthOptions = {}): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'constants',
...
export function maxBps(options: MaxBpsOptions = {}): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'constants',
...
export function yearMs(options: YearMsOptions = {}): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'constants',
...
export function gracePeriodMs(options: GracePeriodMsOptions = {}): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'constants',
...
export function subdomainAllowCreationKey(options: SubdomainAllowCreationKeyOptions = {}): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'constants',
...
export function subdomainAllowExtensionKey(options: SubdomainAllowExtensionKeyOptions = {}): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'constants',
...
export function leafExpirationTimestamp(options: LeafExpirationTimestampOptions = {}): (tx: Transaction) => TransactionResult {
    const packageAddress = options.package ?? '@suins/core';
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'constants',
