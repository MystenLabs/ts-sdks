...
answer: >-
  The Sui SDK supports Ed25519, Secp256k1, Secp256r1, and ML-DSA-65 keypairs, plus external signers
  (AWS KMS, GCP KMS, Ledger, WebCrypto, Passkey) through a unified Signer interface.
goal:
  description: >-
...
signature format. Sui supports four schemes, each with a corresponding `Keypair` class:
...
| `getKeyScheme()` | Returns the signature scheme (`ED25519`, `Secp256k1`, `Secp256r1`, `MLDSA65`) |
